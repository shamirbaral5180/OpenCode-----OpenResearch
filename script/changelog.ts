...
Generates UPCOMING_CHANGELOG.md by running the openresearch changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for openresearch run (default: low)
      --quiet            Suppress openresearch command output unless it fails
