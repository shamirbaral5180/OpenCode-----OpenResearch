...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/openresearch/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/openresearch...\n")
...
console.log("Fetching npm all-time downloads for openresearch-ai...\n")
const npmDownloads = await fetchNpmDownloads("openresearch-ai")
