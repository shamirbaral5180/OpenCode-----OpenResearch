...
# Package managers
npm i -g openresearch-ai@latest        # or bun/pnpm/yarn
scoop install openresearch             # Windows
choco install openresearch             # Windows
brew install anomalyco/tap/openresearch # macOS and Linux (recommended, always up to date)
brew install openresearch              # macOS and Linux (official brew formula, updated less)
sudo pacman -S openresearch            # Arch Linux (Stable)
paru -S openresearch-bin               # Arch Linux (Latest from AUR)
mise use -g openresearch               # Any OS
nix run nixpkgs#openresearch           # or github:anomalyco/openresearch for latest dev branch
```
...
OpenResearch ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/anomalyco/openresearch/releases) অথবা [openresearch.ai/download](https://openresearch.ai/download) থেকে ডাউনলোড করুন।
...
1. `$OPENRESEARCH_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.openresearch/bin` - ডিফল্ট ফলব্যাক
...
OpenResearch এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://openresearch.ai/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে OpenResearch কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://openresearch.ai/docs)।

### অবদান (Contributing)

আপনি যদি OpenResearch এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### OpenResearch এর উপর বিল্ডিং (Building on OpenResearch)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা OpenResearch এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "openresearch" ব্যবহার করেন, উদাহরণস্বরূপ "openresearch-dashboard" বা "openresearch-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি OpenResearch দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/openresearch) | [X.com](https://x.com/openresearch)
