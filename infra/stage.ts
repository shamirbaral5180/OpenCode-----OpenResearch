export const domain = (() => {
  if ($app.stage === "production") return "openresearch.ai"
  if ($app.stage === "dev") return "dev.openresearch.ai"
  return `${$app.stage}.dev.openresearch.ai`
})()
