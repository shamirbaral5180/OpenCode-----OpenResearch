...
// verified: OpenResearch Go (tier=Go, dataset=zen), June 1-30, 2026.
    ...
    <AbsoluteFill style={{ background: c.bg, color: c.ink, fontFamily: MONO, padding: 72, boxSizing: "border-box" }}>
      <div style={{ height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <div style={{ fontSize: 25, fontWeight: 600, color: c.muted, letterSpacing: 3 }}>OPENRESEARCH GO · JUNE 2026</div>
