...
import type { EffectDrizzleSqlite } from "@openresearch-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/ProjectDirectories") {}
