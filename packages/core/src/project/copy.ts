...
import { Event } from "@openresearch-ai/schema/project-directories"
import { ProjectCopy } from "@openresearch-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/ProjectCopy") {}
