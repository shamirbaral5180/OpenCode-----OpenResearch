...
import { type Model } from "@openresearch-ai/llm"
import * as AnthropicMessages from "@openresearch-ai/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@openresearch-ai/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@openresearch-ai/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@openresearch-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/v2/SessionRunnerModel") {}
