...
import { Entry, FileSystem, FindInput, Match } from "@openresearch-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@openresearch-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/v2/FileSystem") {}
