...
export class Service extends Context.Service<Service, Interface>()("@openresearch/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.OPENRESEARCH_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
