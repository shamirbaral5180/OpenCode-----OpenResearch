...
import { FileSystemWatcher } from "@openresearch-ai/schema/filesystem-watcher"
...
declare const OPENRESEARCH_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof OPENRESEARCH_LIBC === "undefined" ? undefined : OPENRESEARCH_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.OPENRESEARCH_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.OPENRESEARCH_EXPERIMENTAL_FILEWATCHER)) {
