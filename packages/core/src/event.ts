...
import type { Data, Definition, Payload } from "@openresearch-ai/schema/event"
...
import { Durable } from "@openresearch-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@openresearch-ai/schema/event").ID
export type { Data, Definition, Payload } from "@openresearch-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/Event") {}
