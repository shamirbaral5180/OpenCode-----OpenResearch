...
import { Catalog } from "@openresearch-ai/schema/catalog"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/v2/Catalog") {}
    ...
    const result: Interface = {
      ...
      model: {
        ...
        small: Effect.fn("CatalogV2.model.small")(function* (providerID) {
          ...
          if (providerID === ProviderV2.ID.openresearch) {
