...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@openresearch-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/v2/ToolRegistry") {}
