...
import type { Plugin as PluginRuntime } from "@openresearch-ai/plugin/v2/effect"
import { Plugin } from "@openresearch-ai/schema/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/v2/Plugin") {}
