import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@openresearch-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
