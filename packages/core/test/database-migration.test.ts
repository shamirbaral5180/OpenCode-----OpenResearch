...
import { EffectDrizzleSqlite } from "@openresearch-ai/effect-drizzle-sqlite"
import { Effect, Layer } from "effect"
import { eq, inArray, sql } from "drizzle-orm"
import { DatabaseMigration } from "@openresearch-ai/core/database/migration"
import { migrations } from "@openresearch-ai/core/database/migration.gen"
import workspaceNameMigration from "@openresearch-ai/core/database/migration/20260410174513_workspace-name"
import sessionUsageMigration from "@openresearch-ai/core/database/migration/20260510033149_session_usage"
import normalizeStoragePathsMigration from "@openresearch-ai/core/database/migration/20260601010001_normalize_storage_paths"
import sessionMessageProjectionOrderMigration from "@openresearch-ai/core/database/migration/20260603040000_session_message_projection_order"
import eventSourcedSessionInputMigration from "@openresearch-ai/core/database/migration/20260604172448_event_sourced_session_input"
import contextEpochAgentMigration from "@openresearch-ai/core/database/migration/20260605042240_add_context_epoch_agent"
import simplifyIntegrationCredentialsMigration from "@openresearch-ai/core/database/migration/20260611192811_lush_chimera"
import simplifySessionInputMigration from "@openresearch-ai/core/database/migration/20260622202450_simplify_session_input"
...
import { SessionSchema } from "@openresearch-ai/core/session/schema"
import { SessionTable } from "@openresearch-ai/core/session/sql"
import sessionMetadataMigration from "@openresearch-ai/core/database/migration/20260511173437_session-metadata"
