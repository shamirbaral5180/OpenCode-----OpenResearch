...
declare const OPENRESEARCH_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof OPENRESEARCH_CLI_NAME === "string" ? OPENRESEARCH_CLI_NAME : "openresearch", {
  description: "OpenResearch 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
