...
const en = {
  "app.title": "AI Model Usage Rankings | OpenResearch Data",
  "app.description":
    "Explore OpenResearch usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "OpenResearch Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star OpenResearch on GitHub",
  "header.github": "GitHub",
  "header.tryOpenResearch": "Try OpenResearch",
  ...
  "footer.homeAria": "OpenResearch home",
  ...
  "home.topModelsDescription": "Usage of models across OpenResearch.",
  ...
  "home.uniqueUsersDescription": "Daily unique OpenResearch users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | OpenResearch Data",
  "lab.description":
    "Compare {{lab}} models used in OpenResearch, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent OpenResearch usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in OpenResearch",
  ...
  "lab.shareOfUsage": "{{share}} of recent OpenResearch usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | OpenResearch Data",
  "model.description":
    "View {{model}} OpenResearch usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. OpenResearch usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's OpenResearch usage",
  "model.ranked": "Ranked #{{rank}} across last week's OpenResearch usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No OpenResearch usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no OpenResearch usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No OpenResearch geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent OpenResearch token volume.",
