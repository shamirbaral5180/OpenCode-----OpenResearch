export const dict = {
  "app.title": "Ranking de uso de modelos de IA | OpenResearch Data",
  "app.description":
    "Explore o uso do OpenResearch em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do OpenResearch Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao OpenResearch no GitHub",
  "header.github": "GitHub",
  "header.tryOpenResearch": "Experimente o OpenResearch",
  ...
  "footer.homeAria": "Início do OpenResearch",
  ...
  "modal.title": "Newsletter do OpenResearch",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no OpenResearch.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do OpenResearch por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | OpenResearch Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no OpenResearch, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do OpenResearch.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no OpenResearch",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do OpenResearch",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do OpenResearch nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | OpenResearch Data",
  "model.description":
    "Veja dados de uso de {{model}} no OpenResearch, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no OpenResearch aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do OpenResearch da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do OpenResearch da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do OpenResearch na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do OpenResearch, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do OpenResearch.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do OpenResearch na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do OpenResearch na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do OpenResearch.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do OpenResearch correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do OpenResearch.",
