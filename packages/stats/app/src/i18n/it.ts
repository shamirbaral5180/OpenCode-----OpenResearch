export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | OpenResearch Data",
  "app.description":
    "Esplora l'utilizzo di OpenResearch nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo OpenResearch Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a OpenResearch su GitHub",
  "header.github": "GitHub",
  "header.tryOpenResearch": "Prova OpenResearch",
  ...
  "footer.homeAria": "Home OpenResearch",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in OpenResearch.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di OpenResearch per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | OpenResearch Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in OpenResearch, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di OpenResearch.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in OpenResearch",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di OpenResearch",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token OpenResearch negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | OpenResearch Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in OpenResearch, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di OpenResearch appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo OpenResearch della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo OpenResearch della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di OpenResearch nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di OpenResearch, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di OpenResearch.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token OpenResearch nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di OpenResearch nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione OpenResearch.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica OpenResearch corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token OpenResearch.",
