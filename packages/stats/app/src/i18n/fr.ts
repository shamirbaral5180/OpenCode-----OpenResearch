export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | OpenResearch Data",
  "app.description":
    "Explorez l'utilisation d'OpenResearch par modèle d'IA, avec le volume de tokens, les classements, la part de marché, le prix des tokens, le coût par session, le taux de cache et les répartitions géographiques.",
  "app.unfurlAlt": "Logo textuel OpenResearch Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à OpenResearch sur GitHub",
  "header.github": "GitHub",
  "header.tryOpenResearch": "Essayer OpenResearch",
  ...
  "footer.homeAria": "Accueil OpenResearch",
  ...
  "modal.title": "Newsletter OpenResearch",
  ...
  "home.topModelsDescription": "Utilisation des modèles dans OpenResearch.",
  ...
  "home.uniqueUsersDescription": "Utilisateurs uniques quotidiens d'OpenResearch par modèle.",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | OpenResearch Data",
  "lab.description":
    "Comparez les modèles {{lab}} utilisés dans OpenResearch, avec l'utilisation des tokens, les classements de modèles, les fenêtres de contexte, les dates de sortie, les coûts et les données propres aux modèles.",
  "lab.loadingTitle": "Laboratoire de modèles",
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'OpenResearch.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans OpenResearch",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'OpenResearch",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens OpenResearch sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | OpenResearch Data",
  "model.description":
    "Consultez les données d'utilisation OpenResearch de {{model}}, avec le volume de tokens, le rang hebdomadaire, la répartition des tokens, les coûts, le taux de cache, les sessions, les répartitions géographiques et les modèles proches.",
  ...
  "model.catalogFallback":
    "Faits du modèle issus de l'index partagé des modèles. L'utilisation OpenResearch apparaîtra dès que ce modèle aura de l'activité.",
  "model.unranked": "Non classé dans l'utilisation OpenResearch de la semaine dernière",
  "model.ranked": "Classé #{{rank}} dans l'utilisation OpenResearch de la semaine dernière",
  ...
  "model.noCurrentUsage": "Aucune utilisation OpenResearch dans la fenêtre de données actuelle.",
  ...
  "model.overviewDescription": "Tokens OpenResearch récents, utilisateurs uniques et position sur le marché.",
  "model.noSummaryTitle": "Aucun résumé d'utilisation",
  "model.noSummaryDescription": "Ce modèle n'a pas encore de lignes d'utilisation OpenResearch.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume quotidien de tokens OpenResearch sur la fenêtre récente de deux mois.",
  ...
  "model.usersDescription": "Utilisateurs uniques quotidiens d'OpenResearch sur la fenêtre récente de deux mois.",
  ...
  "model.efficiencyDescription": "Coût, comportement du cache et forme moyenne des sessions OpenResearch.",
  ...
  "model.noGeoDescription": "Aucune ligne géographique OpenResearch ne correspondait à ce modèle.",
  "model.peersDescription": "Modèles proches par volume récent de tokens OpenResearch.",
