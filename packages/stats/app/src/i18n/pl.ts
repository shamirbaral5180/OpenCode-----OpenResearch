export const dict = {
  "app.title": "Rankingi użycia modeli AI | OpenResearch Data",
  "app.description":
    "Przeglądaj użycie OpenResearch w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny OpenResearch Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę OpenResearch na GitHub",
  "header.github": "GitHub",
  "header.tryOpenResearch": "Wypróbuj OpenResearch",
  ...
  "footer.homeAria": "Strona główna OpenResearch",
  ...
  "home.topModelsDescription": "Użycie modeli w OpenResearch.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy OpenResearch według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | OpenResearch Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w OpenResearch, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia OpenResearch.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w OpenResearch",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia OpenResearch",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów OpenResearch z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | OpenResearch Data",
  "model.description":
    "Zobacz dane użycia {{model}} w OpenResearch, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie OpenResearch pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu OpenResearch z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu OpenResearch z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia OpenResearch w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny OpenResearch, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia OpenResearch.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów OpenResearch w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy OpenResearch w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji OpenResearch.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne OpenResearch nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów OpenResearch.",
