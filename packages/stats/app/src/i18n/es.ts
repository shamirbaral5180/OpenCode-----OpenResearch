export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | OpenResearch Data",
  "app.description":
    "Explora el uso de OpenResearch en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de OpenResearch Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a OpenResearch en GitHub",
  "header.github": "GitHub",
  "header.tryOpenResearch": "Probar OpenResearch",
  ...
  "footer.homeAria": "Inicio de OpenResearch",
  ...
  "modal.title": "Boletín de OpenResearch",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en OpenResearch.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de OpenResearch por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | OpenResearch Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en OpenResearch, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de OpenResearch.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en OpenResearch",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de OpenResearch",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de OpenResearch durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | OpenResearch Data",
  "model.description":
    "Consulta datos de uso de {{model}} en OpenResearch, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de OpenResearch aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de OpenResearch de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de OpenResearch de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de OpenResearch en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de OpenResearch, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de OpenResearch.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de OpenResearch durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de OpenResearch durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de OpenResearch.",
  ...
  "model.noGeoDescription": "Ninguna fila geográfica de OpenResearch coincidió con este modelo.",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de OpenResearch.",
