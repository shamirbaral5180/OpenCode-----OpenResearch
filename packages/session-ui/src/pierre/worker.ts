...
import { registerOpenResearchTheme } from "@openresearch-ai/ui/context/marked-theme-register"

registerOpenResearchTheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for OpenResearch, as I think 8 might be
