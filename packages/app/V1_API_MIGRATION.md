...
The app is currently hybrid. In this document, V1 refers to the legacy unprefixed server APIs used by `@openresearch-ai/sdk/v2`, despite the SDK package name.
...
- [ ] Remove the `@openresearch-ai/sdk` runtime dependency after all legacy calls and types are gone.
  - `package.json`
