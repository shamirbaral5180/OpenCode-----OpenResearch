...
const directory = "C:/OpenResearch/TerminalComposerFocus"
...
function seedCachedTerminal(page: Page) {
  return page.addInitScript(
    ({ terminalKey, ptyID }) => {
      localStorage.setItem("openresearch.global.dat:layout", JSON.stringify({ terminal: { height: 320, opened: true } }))
