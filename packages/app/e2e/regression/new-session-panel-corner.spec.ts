...
const directory = "C:/OpenResearch/NewSessionPanelCorner"
...
test("matches the rounded panel corners to the dark new-session background", async ({ page }, testInfo) => {
  ...
  await page.addInitScript(
    ({ directory, draftID, server }) => {
      ...
      localStorage.setItem("openresearch-theme-id", "oc-2")
      localStorage.setItem("openresearch-color-scheme", "dark")
