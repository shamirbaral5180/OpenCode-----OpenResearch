...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "OpenResearch failed to load",
  "desktop.recovery.terminated": "OpenResearch window terminated unexpectedly",
  "desktop.recovery.unresponsive": "OpenResearch is not responding",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.openresearchMissing": "openresearch is not installed in this distro",
  "desktop.wsl.error.openresearchCannotRun": "openresearch is installed but could not run",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OpenResearch update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
