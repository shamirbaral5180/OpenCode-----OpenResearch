export const dict = {
  ...
  "desktop.recovery.loadFailed": "OpenResearch መጫን አልቻለም",
  "desktop.recovery.terminated": "OpenResearch መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "OpenResearch ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearchመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.openresearchMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.openresearchCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "OpenResearch ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.openresearch.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.openresearchGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በOpenResearch",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በOpenResearch ይጠቀሙ።",
  ...
  "provider.connect.openresearchZen.line1": "OpenResearch ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.openresearchZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.openresearchZen.visit.prefix": "ጎብኝ ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  "provider.connect.oauth.code.visit.prefix": "ጎብኝ ",
  "provider.connect.oauth.code.visit.link": "ይህ ሊንክ",
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በOpenResearch ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በOpenResearch ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ openresearch.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው OpenResearch አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpenResearch": "መፈተሽ OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "OpenResearchን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpenResearch": "በማዘመን ላይ OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "በማዘመን ላይ OpenResearch በ{{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "አዘምን OpenResearch በ{{distro}}።",
  "wsl.onboarding.updateOpenResearch": "አዘምን OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.openresearchReady": "OpenResearch ዝግጁ ነው።",
  "wsl.onboarding.installOpenResearchIn": "መጫን OpenResearch በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpenResearch": "ጫን OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearchአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) OpenResearch WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ OpenResearch።",
  ...
  "help.tabs.introduction": "OpenResearch ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የOpenResearch ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለOpenResearch ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (openresearch.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ OpenResearch እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "OpenResearch ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የOpenResearch አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለOpenResearch",
  ...
  "settings.general.row.appearance.description": "OpenResearchበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "OpenResearch ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "OpenResearch ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "OpenResearch ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የOpenResearch እትም እያሄዱ ነው።",
