export const dict = {
  ...
  "desktop.menu.documentation": "OpenResearch dokumentācija",
  ...
  "desktop.menu.ariaLabel": "OpenResearch izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt OpenResearch",
  "desktop.recovery.terminated": "OpenResearch logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "OpenResearch neatbild",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.openresearchMissing": "openresearch nav instalēts šajā distribūcijā",
  "desktop.wsl.error.openresearchCannotRun": "openresearch ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OpenResearch atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.openresearch.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.openresearchGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Apmeklējiet",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus OpenResearch.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti openresearch.json",
  ...
  "dialog.server.description": "Mainiet, pie kura OpenResearch servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Pārbaudu OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Pārbaudu OpenResearch distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Atjauninu OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Atjauninu OpenResearch distribūcijā {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Atjauniniet OpenResearch distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Atjauniniet OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch ir gatavs.",
  "wsl.onboarding.installOpenResearchIn": "Instalējiet OpenResearch distribūcijā {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Instalējiet OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms OpenResearch var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet OpenResearch no jauna.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna OpenResearch versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu OpenResearch komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (openresearch.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, OpenResearch vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "OpenResearch darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist OpenResearch serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt OpenResearch saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā OpenResearch izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai OpenResearch sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet OpenResearch tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot OpenResearch",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko OpenResearch versiju.",
