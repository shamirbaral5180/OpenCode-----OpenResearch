export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'OpenResearch",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'OpenResearch",
  "desktop.recovery.terminated": "La fenêtre OpenResearch s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "OpenResearch ne répond pas",
  ...
  "desktop.wsl.error.installOpenResearch": "Échec de l'installation d'OpenResearch",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.openresearchMissing": "openresearch n'est pas installé dans cette distribution",
  "desktop.wsl.error.openresearchCannotRun": "openresearch est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'OpenResearch est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.openresearch.tagline": "Modèles optimisés et fiables",
  "dialog.provider.openresearchGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Visitez ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans OpenResearch.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans openresearch.json",
  ...
  "dialog.server.description": "Changez le serveur OpenResearch auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Vérification d'OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Vérification d'OpenResearch dans {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Mise à jour d'OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Mise à jour d'OpenResearch dans {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Mettez à jour OpenResearch dans {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Mettre à jour OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch est prêt dans {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch est prêt.",
  "wsl.onboarding.installOpenResearchIn": "Installez OpenResearch dans {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Installer OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'OpenResearch puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'OpenResearch ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe OpenResearch",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (openresearch.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'OpenResearch ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "OpenResearch inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur OpenResearch dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour OpenResearch",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'OpenResearch sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si OpenResearch suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'OpenResearch.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'OpenResearch",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'OpenResearch.",
