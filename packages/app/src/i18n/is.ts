...
const desktop = [
  ...
  "Lágmarka",
  "Hámarka",
  "OpenResearch skjölun",
  "Aðstoðarspjallborð",
  "Deila ábendingu",
  "Tilkynna villu",
  "OpenResearch-valmynd",
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða OpenResearch",
  "OpenResearch-glugganum var óvænt lokað",
  "OpenResearch svarar ekki",
  ...
  "Uppsetning OpenResearch mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "openresearch er ekki uppsett í þessari dreifingu",
  "openresearch er uppsett en ekki var hægt að keyra það",
  "OpenResearch er ekki uppsett í {{distro}}",
  "Uppfærslu OpenResearch lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.openresearch.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.openresearch.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.openresearchGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.openresearchZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.openresearchZen.visit.prefix": "Heimsókn",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í OpenResearch.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í openresearch.json",
  ...
  "dialog.server.description": "Skiptu um hvaða OpenResearch miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Athugar OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Athugar OpenResearch í {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Uppfærir OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Uppfærir OpenResearch í {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Uppfærðu OpenResearch í {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Uppfærðu OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch er tilbúið í {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch er tilbúinn.",
  "wsl.onboarding.installOpenResearchIn": "Settu upp OpenResearch í {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Settu upp OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en OpenResearch getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan OpenResearch aftur.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af OpenResearch ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til OpenResearch teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (openresearch.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, OpenResearch styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "OpenResearch inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "OpenResearch skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu OpenResearch netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir OpenResearch",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig OpenResearch lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort OpenResearch fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig OpenResearch er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar OpenResearch ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af OpenResearch.",
