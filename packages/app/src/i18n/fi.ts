export const dict = {
  ...
  "dialog.provider.openresearch.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.openresearch.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.openresearchGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenResearchn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja OpenResearchssa.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Avaa ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja OpenResearchssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja OpenResearchssa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään openresearch.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda OpenResearch-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Tarkistetaan OpenResearcha...",
  "wsl.onboarding.checkingOpenResearchIn": "Tarkistetaan OpenResearcha kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Päivitetään OpenResearcha...",
  "wsl.onboarding.updatingOpenResearchIn": "Päivitetään OpenResearcha kohteessa {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Päivitä OpenResearch jakelussa {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Päivitä OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch on valmis jakelussa {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch on valmis.",
  "wsl.onboarding.installOpenResearchIn": "Asenna OpenResearch jakeluun {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Asenna OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearcha ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin OpenResearch voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten OpenResearch uudelleen.",
  ...
  "toast.update.description": "OpenResearchn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä OpenResearch-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (openresearch.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että OpenResearch ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita OpenResearch-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda OpenResearchn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä OpenResearch näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö OpenResearch järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta OpenResearchn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun OpenResearch käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät OpenResearchn uusinta versiota.",
  ...
  "desktop.menu.documentation": "OpenResearch-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "OpenResearch-valikko",
  ...
  "desktop.recovery.loadFailed": "OpenResearchn lataaminen epäonnistui",
  "desktop.recovery.terminated": "OpenResearch-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "OpenResearch ei vastaa",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearchn asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.openresearchMissing": "openresearcha ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.openresearchCannotRun": "openresearch on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearcha ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OpenResearchn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "OpenResearch Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
