export const dict = {
  ...
  "desktop.menu.documentation": "OpenResearch Documentació",
  ...
  "desktop.menu.ariaLabel": "menú OpenResearch.",
  ...
  "desktop.recovery.loadFailed": "OpenResearch no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra OpenResearch s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "OpenResearch no respon",
  ...
  "desktop.wsl.error.installOpenResearch": "La instal·lació de OpenResearch ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.openresearchMissing": "openresearch no està instal·lat en aquesta distribució",
  "desktop.wsl.error.openresearchCannotRun": "openresearch està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OpenResearch actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.openresearch.tagline": "Models optimitzats fiables",
  "dialog.provider.openresearchGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.openresearchZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a OpenResearch.",
  ...
  "dialog.plugins.empty": "Connectors configurats a openresearch.json",
  ...
  "dialog.server.description": "Canvia a quin OpenResearch servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpenResearch": "S'està comprovant OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "S'està registrant OpenResearch a {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "S'està actualitzant OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "S'està actualitzant OpenResearch a {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Actualitza OpenResearch a {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Actualització OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch està llest a {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch està llest.",
  "wsl.onboarding.installOpenResearchIn": "Instal·leu OpenResearch a {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Instal·la OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que OpenResearch pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de OpenResearch ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip OpenResearch.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (openresearch.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que OpenResearch encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "OpenResearch Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor OpenResearch dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a OpenResearch",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu OpenResearch al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si OpenResearch segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de OpenResearch.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï OpenResearch.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de OpenResearch.",
