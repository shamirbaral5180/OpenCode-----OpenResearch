export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل OpenResearch",
  "desktop.recovery.terminated": "توقفت نافذة OpenResearch بشكل غير متوقع",
  "desktop.recovery.unresponsive": "OpenResearch لا يستجيب",
  ...
  "desktop.wsl.error.installOpenResearch": "فشل تثبيت OpenResearch",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.openresearchMissing": "openresearch غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.openresearchCannotRun": "openresearch مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث OpenResearch، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.openresearch.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.openresearch.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.openresearchGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "يمنحك OpenResearch Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "قم بزيارة ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في OpenResearch.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في openresearch.json",
  ...
  "dialog.server.description": "تبديل خادم OpenResearch الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpenResearch": "جارٍ التحقق من OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "جارٍ التحقق من OpenResearch في {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "جارٍ تحديث OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "جارٍ تحديث OpenResearch في {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "حدّث OpenResearch في {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "تحديث OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch جاهز في {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch جاهز.",
  "wsl.onboarding.installOpenResearchIn": "ثبّت OpenResearch في {{distro}}.",
  "wsl.onboarding.installOpenResearch": "تثبيت OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن OpenResearch من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على OpenResearch التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح OpenResearch.",
  ...
  "help.tabs.introduction": "أصبح OpenResearch Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من OpenResearch ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق OpenResearch",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (openresearch.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن OpenResearch لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن OpenResearch نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم OpenResearch داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ OpenResearch",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور OpenResearch على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان OpenResearch يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة OpenResearch.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل OpenResearch",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من OpenResearch.",
