export const dict = {
  ...
  "desktop.menu.documentation": "OpenResearch دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "OpenResearch لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "OpenResearch دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "OpenResearch جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.openresearchMissing": "اس ڈسٹرو وچ openresearch انسٹال نئیں اے",
  "desktop.wsl.error.openresearchCannotRun": "openresearch انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.openresearchNotInstalled": "{{distro}} وچ OpenResearch انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "OpenResearch دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.openresearch.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.openresearch.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.openresearchGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenResearch دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے OpenResearch وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.openresearchZen.visit.prefix": "ویکھو ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے OpenResearch وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے OpenResearch وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "openresearch.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس OpenResearch سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpenResearch": "OpenResearch چیک کر رئے آں...",
  "wsl.onboarding.checkingOpenResearchIn": "{{distro}} چ OpenResearch دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpenResearch": "OpenResearch نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpenResearchIn": "{{distro}} وچ OpenResearch نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpenResearchIn": "{{distro}} وچ OpenResearch نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpenResearch": "OpenResearch اپ ڈیٹ کرو",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch {{distro}} چ تیار اے۔",
  "wsl.onboarding.openresearchReady": "OpenResearch تیار اے۔",
  "wsl.onboarding.installOpenResearchIn": "{{distro}} وچ OpenResearch انسٹال کرو۔",
  "wsl.onboarding.installOpenResearch": "OpenResearch انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenResearch دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر OpenResearch دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "OpenResearch Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OpenResearch ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع OpenResearch ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (openresearch.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، OpenResearch ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر OpenResearch سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "OpenResearch لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے OpenResearch کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا OpenResearch سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "OpenResearch نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں OpenResearch لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی OpenResearch دا تازہ ترین ورژن چلا رئے او۔",
