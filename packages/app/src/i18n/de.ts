...
export const dict = {
  ...
  "dialog.provider.openresearch.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.openresearch.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.openresearchGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in OpenResearch zu nutzen.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in OpenResearch zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in OpenResearch zu nutzen.",
  ...
  "dialog.plugins.empty": "In openresearch.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den OpenResearch-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpenResearch": "OpenResearch wird geprüft…",
  "wsl.onboarding.checkingOpenResearchIn": "OpenResearch in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpenResearch": "OpenResearch wird aktualisiert…",
  "wsl.onboarding.updatingOpenResearchIn": "OpenResearch in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpenResearchIn": "Aktualisieren Sie OpenResearch in {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "OpenResearch aktualisieren",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch ist in {{distro}} bereit.",
  "wsl.onboarding.openresearchReady": "OpenResearch ist bereit.",
  "wsl.onboarding.installOpenResearchIn": "Installieren Sie OpenResearch in {{distro}}.",
  "wsl.onboarding.installOpenResearch": "OpenResearch installieren",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor OpenResearch einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann OpenResearch erneut.",
  ...
  "toast.update.description": "Eine neue Version von OpenResearch ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem OpenResearch-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (openresearch.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: OpenResearch unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "OpenResearch mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "OpenResearch enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "OpenResearch-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für OpenResearch ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie OpenResearch auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob OpenResearch dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von OpenResearch anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von OpenResearch automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "OpenResearch ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von OpenResearch wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "OpenResearch konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das OpenResearch-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "OpenResearch reagiert nicht",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.openresearchMissing": "openresearch ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.openresearchCannotRun": "openresearch ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das OpenResearch-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "OpenResearch Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
