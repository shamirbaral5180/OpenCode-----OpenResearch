...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "OpenResearch įkelti nepavyko",
  "OpenResearch langas netikėtai užsidarė",
  "OpenResearch neatsako",
  ...
  "OpenResearch įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "openresearch šiame distributyve neįdiegtas",
  "openresearch įdiegtas, bet jo paleisti nepavyko",
  "OpenResearch neįdiegtas distributyve {{distro}}",
  "OpenResearch naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.openresearch.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.openresearch.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.openresearchGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami OpenResearch modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Aplankykite",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius OpenResearch.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti openresearch.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio OpenResearch serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Tikrinama OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Tikrinama OpenResearch {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Atnaujinamas OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Atnaujinamas OpenResearch {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Atnaujinkite OpenResearch {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Atnaujinkite OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch yra paruoštas {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch yra paruoštas.",
  "wsl.onboarding.installOpenResearchIn": "Įdiekite OpenResearch į {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Įdiekite OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad OpenResearch galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują OpenResearch ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą OpenResearch komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (openresearch.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad OpenResearch dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "OpenResearch apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "OpenResearch darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite OpenResearch serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite OpenResearch ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip OpenResearch atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar OpenResearch seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite OpenResearch temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas OpenResearch",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią OpenResearch versiją.",
