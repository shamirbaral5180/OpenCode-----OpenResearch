export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi OpenResearch",
  ...
  "desktop.recovery.loadFailed": "OpenResearch gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap OpenResearch ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "OpenResearch tidak memberi respons",
  ...
  "desktop.wsl.error.installOpenResearch": "Pemasangan OpenResearch gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.openresearchMissing": "openresearch tidak dipasang dalam distro ini",
  "desktop.wsl.error.openresearchCannotRun": "openresearch dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini OpenResearch selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.openresearch.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.openresearchGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Layari",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam OpenResearch.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam openresearch.json",
  ...
  "dialog.server.description": "Tukar pelayan OpenResearch yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Sedang menyemak OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Sedang menyemak OpenResearch dalam {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Sedang mengemas kini OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Sedang mengemas kini OpenResearch dalam {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Kemas kini OpenResearch dalam {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Kemas kini OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch sedia digunakan.",
  "wsl.onboarding.installOpenResearchIn": "Pasang OpenResearch dalam {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Pasang OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum OpenResearch boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu OpenResearch ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan OpenResearch",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (openresearch.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, OpenResearch belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan OpenResearch dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk OpenResearch",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa OpenResearch pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada OpenResearch mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema OpenResearch.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila OpenResearch dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini OpenResearch.",
