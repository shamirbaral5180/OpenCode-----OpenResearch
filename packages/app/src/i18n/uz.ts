export const dict = {
  ...
  "desktop.menu.documentation": "OpenResearch hujjatlari",
  ...
  "desktop.menu.ariaLabel": "OpenResearch menyusi",
  ...
  "desktop.recovery.loadFailed": "OpenResearch yuklanmadi",
  "desktop.recovery.terminated": "OpenResearch oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "OpenResearch javob bermayapti",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.openresearchMissing": "OpenResearch ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.openresearchCannotRun": "openresearch o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "OpenResearch yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.openresearch.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.openresearchGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenResearch tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va OpenResearch’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va OpenResearch da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va OpenResearch da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "openresearch.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi OpenResearch serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpenResearch": "OpenResearch tekshirilmoqda...",
  "wsl.onboarding.checkingOpenResearchIn": "OpenResearch {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpenResearch": "OpenResearch yangilanmoqda...",
  "wsl.onboarding.updatingOpenResearchIn": "OpenResearch {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpenResearchIn": "OpenResearch-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpenResearch": "OpenResearch-ni yangilang",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch {{distro}} da tayyor.",
  "wsl.onboarding.openresearchReady": "OpenResearch tayyor.",
  "wsl.onboarding.installOpenResearchIn": "OpenResearch-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpenResearch": "OpenResearch-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenResearch WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra OpenResearch-ni qayta oching.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OpenResearch ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida OpenResearch jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (openresearch.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, OpenResearch hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "OpenResearch bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi OpenResearch serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "OpenResearch uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "OpenResearch qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "OpenResearch tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "OpenResearch mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "OpenResearch ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz OpenResearch oxirgi versiyasini ishga tushiryapsiz.",
