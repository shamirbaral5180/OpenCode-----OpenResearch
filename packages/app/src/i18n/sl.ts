export const dict = {
  ...
  "desktop.menu.documentation": "OpenResearch Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "OpenResearch ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno OpenResearch se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "OpenResearch se ne odziva",
  ...
  "desktop.wsl.error.installOpenResearch": "Namestitev OpenResearch ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.openresearchMissing": "openresearch ni nameščen v tej distribuciji",
  "desktop.wsl.error.openresearchCannotRun": "openresearch je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev OpenResearch je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.openresearch.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.openresearchGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Obisk ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v OpenResearch.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v openresearch.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom OpenResearch se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Preverjanje OpenResearch ...",
  "wsl.onboarding.checkingOpenResearchIn": "Preverjanje OpenResearch v {{distro}} ...",
  "wsl.onboarding.updatingOpenResearch": "Posodabljanje OpenResearch ...",
  "wsl.onboarding.updatingOpenResearchIn": "Posodabljanje OpenResearch v {{distro}} ...",
  "wsl.onboarding.updateOpenResearchIn": "Posodobite OpenResearch v {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Posodobite OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch je pripravljen v {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch je pripravljen.",
  "wsl.onboarding.installOpenResearchIn": "Namestite OpenResearch v {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Namestite OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko OpenResearch doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica OpenResearch ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi OpenResearch",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (openresearch.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, OpenResearch še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik OpenResearch znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za OpenResearch",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako OpenResearch izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali OpenResearch sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo OpenResearch.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene OpenResearch",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico OpenResearch.",
