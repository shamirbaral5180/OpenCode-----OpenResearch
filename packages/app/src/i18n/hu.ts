...
const desktop = [
  ...
  "Kilépés",
  "Az OpenResearch betöltése sikertelen",
  "Az OpenResearch ablaka váratlanul leállt",
  "Az OpenResearch nem válaszol",
  ...
  "Az OpenResearch telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az openresearch nincs telepítve ebben a disztribúcióban",
  "Az openresearch telepítve van, de nem futtatható",
  "Az OpenResearch nincs telepítve ebben: {{distro}}",
  "Az OpenResearch frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.openresearch.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.openresearch.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.openresearchGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A OpenResearch ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a OpenResearch-ben.",
  ...
  "provider.connect.openresearchZen.line1":
    "A OpenResearch Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Látogatás",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a OpenResearch-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a OpenResearch-ben.",
  ...
  "dialog.plugins.empty": "Az openresearch.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik OpenResearch szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpenResearch": "OpenResearch ellenőrzése...",
  "wsl.onboarding.checkingOpenResearchIn": "OpenResearch ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOpenResearch": "OpenResearch frissítése...",
  "wsl.onboarding.updatingOpenResearchIn": "OpenResearch frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateOpenResearchIn": "Frissítse a OpenResearch-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpenResearch": "Frissítse a OpenResearch-t",
  "wsl.onboarding.openresearchReadyIn": "A OpenResearch készen áll a {{distro}}-ben.",
  "wsl.onboarding.openresearchReady": "A OpenResearch készen áll.",
  "wsl.onboarding.installOpenResearchIn": "Telepítse a OpenResearch-t a {{distro}}-be.",
  "wsl.onboarding.installOpenResearch": "Telepítse a OpenResearch-t",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "A OpenResearch nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a OpenResearch hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A OpenResearch nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a OpenResearch programot.",
  ...
  "help.tabs.introduction": "A OpenResearch Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A OpenResearch ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a OpenResearch csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (openresearch.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a OpenResearch még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A OpenResearch ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "OpenResearch asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a OpenResearch szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a OpenResearch kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a OpenResearch az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a OpenResearch a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a OpenResearch témáját.",
  ...
  "settings.updates.row.startup.description": "A OpenResearch indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a OpenResearch legújabb verzióját futtatja.",
