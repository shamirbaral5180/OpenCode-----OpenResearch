...
export const dict = {
  ...
  "dialog.provider.openresearch.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.openresearch.tagline": "Reliable optimized models",
  "dialog.provider.openresearchGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Visit ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " to collect your API key.",
  ...
  "prompt.placeholder.normal": 'Explore a research question... "{{example}}"',
  "prompt.placeholder.simple": "Ask a research question...",
  ...
  "prompt.example.1": "Find peer-reviewed papers on this topic",
  "prompt.example.2": "Summarize the key findings in this paper",
  "prompt.example.3": "Compare the methods used in these studies",
  "prompt.example.4": "Explain the theory behind this result",
  "prompt.example.5": "Assess the strength of evidence for this claim",
  "prompt.example.6": "Help me design a literature search",
  "prompt.example.7": "Identify gaps in the existing research",
  "prompt.example.8": "What are the limitations of this study?",
  "prompt.example.9": "Find primary sources for this argument",
  "prompt.example.10": "Draft an outline for a literature review",
  "prompt.example.11": "Explain the statistical methods in this paper",
  "prompt.example.12": "Check whether these citations support the claims",
  "prompt.example.13": "Develop a research question about this topic",
  "prompt.example.14": "Suggest a reproducible study design",
  "prompt.example.15": "Critically review this research proposal",
  "prompt.example.16": "Compare competing explanations for these findings",
  "prompt.example.17": "Explain this equation and its assumptions",
  "prompt.example.18": "Turn these notes into a research summary",
  "prompt.example.19": "Create an evidence table from these papers",
  "prompt.example.20": "What recent work challenges this conclusion?",
  "prompt.example.21": "Help me plan a systematic review",
  "prompt.example.22": "Identify potential confounders in this study",
  "prompt.example.23": "Extract the main results from this report",
  "prompt.example.24": "Build an annotated bibliography on this topic",
  "prompt.example.25": "What evidence would help resolve this uncertainty?",
  ...
  "dialog.plugins.empty": "Plugins configured in openresearch.json",
  ...
  "wsl.onboarding.checkingOpenResearch": "Checking OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Checking OpenResearch in {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Updating OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Updating OpenResearch in {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Update OpenResearch in {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Update OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch is ready in {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch is ready.",
  "wsl.onboarding.installOpenResearchIn": "Install OpenResearch in {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Install OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before OpenResearch can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "error.chain.checkConfig": "Check your config (openresearch.json) provider/model names",
  ...
  "home.recentProjects": "Recent research projects",
  "home.empty.title": "No recent research projects",
  "home.empty.description": "Open a local folder for your sources, notes, and research",
  "home.title": "Home",
  ...
  "home.sessions.empty.description": "Start a session to explore a research question",
  ...
  "session.new.title": "Research anything",
  ...
  "app.name": "OpenResearch",
  "app.name.desktop": "OpenResearch Desktop",

  "settings.section.desktop": "Desktop",
  "settings.section.research": "Research",
  "settings.section.server": "Server",
  "settings.tab.general": "General",
  "settings.tab.agent": "Agent Settings",
  "settings.tab.shortcuts": "Shortcuts",
  "settings.tab.systemPrompt": "System Prompt",
  "settings.tab.skills": "Skills",
  "settings.tab.aiContext": "AI Context",
  "settings.tab.modelInput": "Model Input",
  ...
  "settings.research.prompt.saved.title": "Research prompt saved",
  "settings.research.prompt.reset.title": "Research prompt reset",
  "settings.skills.installed.title": "Installed skills",
  "settings.skills.installed.description": "Skills discovered from config directories and registered skill paths.",
  "settings.research.skills.empty": "No skills discovered.",
  "settings.skills.paths.title": "Skill folders",
  ...
  "settings.modelInput.title": "Model Input",
  ...
  "settings.aiContext.invalid": "The AI context configuration must be a JSON object.",
  "settings.agent.title": "Agent Settings",
  "settings.agent.reload": "Reload",
  "settings.agent.save": "Save changes",
  "settings.agent.saved": "Agent settings saved",
  "settings.agent.optional": "Optional",
  "settings.agent.section.direction": "Research direction",
  "settings.agent.section.model": "Model behavior",
  "settings.agent.section.tools": "Tools and provider controls",
  ...
  "settings.agent.error.topP": "Top P must be a number from 0 to 1.",
  "settings.agent.error.steps": "Maximum agent steps must be a positive integer.",
