...
export const dict = {
  ...
  "desktop.menu.documentation": "OpenResearch-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "OpenResearch-meny",
  ...
  "desktop.recovery.loadFailed": "OpenResearch kunne ikke lastes inn",
  "desktop.recovery.terminated": "OpenResearch-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "OpenResearch svarer ikke",
  ...
  "desktop.wsl.error.installOpenResearch": "Installasjonen av OpenResearch mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.openresearchMissing": "openresearch er ikke installert i denne distribusjonen",
  "desktop.wsl.error.openresearchCannotRun": "openresearch er installert, men kunne ikke kjøres",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av OpenResearch er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.openresearch.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.openresearchGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Besøk ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OpenResearch.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i openresearch.json",
  ...
  "dialog.server.description": "Bytt hvilken OpenResearch-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OpenResearch ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OpenResearch-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (openresearch.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OpenResearch ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør OpenResearch-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OpenResearch",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OpenResearch ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om OpenResearch skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i OpenResearch.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når OpenResearch starter",
  ...
  "settings.updates.toast.latest.title": "OpenResearch er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OpenResearch.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Sjekker OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Sjekker OpenResearch i {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Oppdaterer OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Oppdaterer OpenResearch i {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Oppdater OpenResearch i {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Oppdater OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch er klar i {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch er klar.",
  "wsl.onboarding.installOpenResearchIn": "Installer OpenResearch i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før OpenResearch kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter OpenResearch på nytt.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
