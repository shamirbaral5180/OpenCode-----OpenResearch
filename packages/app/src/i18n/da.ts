export const dict = {
  ...
  "dialog.provider.openresearch.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.openresearch.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.openresearchGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Besøg ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i OpenResearch.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i openresearch.json",
  ...
  "dialog.server.description": "Skift hvilken OpenResearch-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Tjekker OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Tjekker OpenResearch i {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Opdaterer OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Opdaterer OpenResearch i {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Opdater OpenResearch i {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Opdater OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før OpenResearch kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter OpenResearch igen.",
  ...
  "toast.update.description": "En ny version af OpenResearch ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OpenResearch-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (openresearch.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OpenResearch understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør OpenResearch-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OpenResearch",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan OpenResearch ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om OpenResearch skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas OpenResearchs tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OpenResearch starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OpenResearch.",
  ...
  "desktop.recovery.loadFailed": "OpenResearch kunne ikke indlæses",
  "desktop.recovery.terminated": "OpenResearch-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpenResearch": "Installationen af OpenResearch mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.openresearchMissing": "openresearch er ikke installeret i denne distribution",
  "desktop.wsl.error.openresearchCannotRun": "openresearch er installeret, men kunne ikke køre",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af OpenResearch er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "OpenResearch Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
