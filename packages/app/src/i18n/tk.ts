export const dict = {
  ...
  "desktop.menu.documentation": "OpenResearch Resminamalar",
  ...
  "desktop.menu.ariaLabel": "OpenResearch menýusy",
  ...
  "desktop.recovery.loadFailed": "OpenResearch ýükläp bilmedi",
  "desktop.recovery.terminated": "OpenResearch penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "OpenResearch jogap berenok",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.openresearchMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.openresearchCannotRun": "openresearch guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "OpenResearch täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.openresearch.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.openresearchGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenResearch tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we OpenResearch-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Sapar ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini OpenResearch-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini OpenResearch-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "openresearch.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy OpenResearch serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpenResearch": "OpenResearch barlamak ...",
  "wsl.onboarding.checkingOpenResearchIn": "{{distro}} içinde OpenResearch barlanýar...",
  "wsl.onboarding.updatingOpenResearch": "OpenResearch täzelenmek ...",
  "wsl.onboarding.updatingOpenResearchIn": "{{distro}}-de OpenResearch täzelenmek ...",
  "wsl.onboarding.updateOpenResearchIn": "OpenResearch-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpenResearch": "OpenResearch täzeläň",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch {{distro}}-de taýýar.",
  "wsl.onboarding.openresearchReady": "OpenResearch taýýar.",
  "wsl.onboarding.installOpenResearchIn": "{{distro}}-de OpenResearch guruň.",
  "wsl.onboarding.installOpenResearch": "OpenResearch guruň",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) OpenResearch WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra OpenResearch açyň.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin OpenResearch ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy OpenResearch toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (openresearch.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, OpenResearch entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "OpenResearch serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "OpenResearch üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "OpenResearch enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "OpenResearch ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "OpenResearch-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "OpenResearch işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "OpenResearch-iň iň soňky wersiýasyny işleýärsiňiz.",
