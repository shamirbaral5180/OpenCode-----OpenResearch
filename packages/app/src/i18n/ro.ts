export const dict = {
  ...
  "desktop.menu.documentation": "Documentație OpenResearch",
  ...
  "desktop.menu.ariaLabel": "Meniu OpenResearch",
  ...
  "desktop.recovery.loadFailed": "OpenResearch nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra OpenResearch s-a închis neașteptat",
  "desktop.recovery.unresponsive": "OpenResearch nu răspunde",
  ...
  "desktop.wsl.error.installOpenResearch": "Instalarea OpenResearch a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.openresearchMissing": "openresearch nu este instalat în această distribuție",
  "desktop.wsl.error.openresearchCannotRun": "openresearch este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea OpenResearch s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.openresearch.tagline": "Modele optimizate, fiabile",
  "dialog.provider.openresearchGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.openresearchZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.openresearchZen.visit.prefix": "Vizitează",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în OpenResearch.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în openresearch.json",
  ...
  "dialog.server.description": "Schimbă serverul OpenResearch la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Se verifică OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Se verifică OpenResearch în {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Se actualizează OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Se actualizează OpenResearch în {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Actualizează OpenResearch în {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Actualizează OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch este gata în {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch este gata.",
  "wsl.onboarding.installOpenResearchIn": "Instalează OpenResearch în {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Instalează OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca OpenResearch să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune OpenResearch ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei OpenResearch",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (openresearch.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, OpenResearch nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul OpenResearch în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru OpenResearch",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul OpenResearch pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă OpenResearch urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema OpenResearch.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea OpenResearch",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune OpenResearch.",
