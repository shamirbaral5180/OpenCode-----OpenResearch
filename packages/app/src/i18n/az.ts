export const dict = {
  ...
  "desktop.recovery.loadFailed": "OpenResearch yüklənə bilmədi",
  "desktop.recovery.terminated": "OpenResearch pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "OpenResearch cavab vermir",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.openresearchMissing": "Bu distribütivdə openresearch quraşdırılmayıb",
  "desktop.wsl.error.openresearchCannotRun": "openresearch quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "OpenResearch yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.openresearch.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.openresearchGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenResearch tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və OpenResearch-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və OpenResearch-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və OpenResearch-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər openresearch.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu OpenResearch serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpenResearch": "OpenResearch yoxlanılır...",
  "wsl.onboarding.checkingOpenResearchIn": "{{distro}}-də OpenResearch yoxlanılır...",
  "wsl.onboarding.updatingOpenResearch": "OpenResearch yenilənir...",
  "wsl.onboarding.updatingOpenResearchIn": "{{distro}}-də OpenResearch yenilənir...",
  "wsl.onboarding.updateOpenResearchIn": "{{distro}}-də OpenResearch-u yeniləyin.",
  "wsl.onboarding.updateOpenResearch": "OpenResearch-u yeniləyin",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch {{distro}}-də hazırdır.",
  "wsl.onboarding.openresearchReady": "OpenResearch hazırdır.",
  "wsl.onboarding.installOpenResearchIn": "OpenResearch-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpenResearch": "OpenResearch quraşdırın",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenResearch WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra OpenResearch-u yenidən açın.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OpenResearch-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı OpenResearch komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (openresearch.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: OpenResearch hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində OpenResearch serverini işlət.",
  ...
  "settings.general.row.language.description": "OpenResearch üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "OpenResearch-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "OpenResearch-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "OpenResearch-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "OpenResearch açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "OpenResearch-un ən son versiyasından istifadə edirsiniz.",
