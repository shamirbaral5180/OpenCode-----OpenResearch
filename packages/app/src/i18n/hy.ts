export const dict = {
  ...
  "desktop.menu.documentation": "OpenResearch Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "OpenResearch մենյու",
  ...
  "desktop.recovery.loadFailed": "OpenResearch չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "OpenResearch պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "OpenResearch-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.openresearchMissing": "openresearch-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.openresearchCannotRun": "openresearch-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OpenResearch թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.openresearch.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.openresearchGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և OpenResearch-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Այցելություն ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և OpenResearch-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և OpenResearch-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են openresearch.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ OpenResearch սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpenResearch": "Ստուգում է OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Ստուգում է OpenResearch-ը {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Թարմացվում է OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Թարմացվում է OpenResearch-ը {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Թարմացնել OpenResearch-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpenResearch": "Թարմացնել OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.openresearchReady": "OpenResearch պատրաստ է։",
  "wsl.onboarding.installOpenResearchIn": "Տեղադրեք OpenResearch-ը {{distro}}-ում։",
  "wsl.onboarding.installOpenResearch": "Տեղադրեք OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի OpenResearch-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք OpenResearch։",
  ...
  "help.tabs.introduction": "OpenResearch Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OpenResearch-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին OpenResearch թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (openresearch.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ OpenResearch-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "OpenResearch ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք OpenResearch սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն OpenResearch",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է OpenResearch տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ OpenResearch-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է OpenResearch-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ OpenResearch-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք OpenResearch-ի վերջին տարբերակը։",
