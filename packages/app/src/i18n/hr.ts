...
const desktop = [
  ...
  "Minimiziraj",
  "Maksimiziraj",
  "Dokumentacija za OpenResearch",
  "Forum za podršku",
  "Pošalji povratne informacije",
  "Prijavi pogrešku",
  "Izbornik OpenResearch",
  ...
  "Nastavi čekati",
  "Izađi",
  "OpenResearch se nije uspio učitati",
  "Prozor aplikacije OpenResearch neočekivano je zatvoren",
  "OpenResearch ne reagira",
  ...
  "Instalacija aplikacije OpenResearch nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "openresearch nije instaliran u ovoj distribuciji",
  "openresearch je instaliran, ali se ne može pokrenuti",
  "OpenResearch nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije OpenResearch je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.openresearch.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.openresearch.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.openresearchGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Posjetiti",
  "provider.connect.openresearchZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u OpenResearch.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u openresearch.json",
  ...
  "dialog.server.description": "Promijenite na koji se OpenResearch poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpenResearchIn": "Provjera OpenResearch u {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Ažuriranje OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Ažuriranje OpenResearch u {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Ažurirajte OpenResearch u {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Ažurirajte OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch je spreman u {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch je spreman.",
  "wsl.onboarding.installOpenResearchIn": "Instalirajte OpenResearch u {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Instalirajte OpenResearch",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što OpenResearch može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite OpenResearch.",
  ...
  "help.tabs.introduction": "Radna površina OpenResearch sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija OpenResearch ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku OpenResearch timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (openresearch.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, OpenResearch još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "OpenResearch Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite OpenResearch poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za OpenResearch",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako OpenResearch izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li OpenResearch slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je OpenResearch tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se OpenResearch pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju OpenResearch.",
