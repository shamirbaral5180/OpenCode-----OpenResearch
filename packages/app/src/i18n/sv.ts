export const dict = {
  ...
  "desktop.recovery.loadFailed": "OpenResearch kunde inte läsas in",
  "desktop.recovery.terminated": "OpenResearch-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "OpenResearch svarar inte",
  ...
  "desktop.wsl.error.installOpenResearch": "Installationen av OpenResearch misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.openresearchMissing": "openresearch är inte installerat i den här distributionen",
  "desktop.wsl.error.openresearchCannotRun": "openresearch är installerat men kunde inte köras",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OpenResearch-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.openresearch.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.openresearch.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.openresearchGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Besök ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i OpenResearch.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i openresearch.json",
  ...
  "dialog.server.description": "Växla vilken OpenResearch-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Kontrollerar OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Kontrollerar OpenResearch i {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Uppdaterar OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Uppdaterar OpenResearch i {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Uppdatera OpenResearch i {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Uppdatera OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch är redo i {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch är redo.",
  "wsl.onboarding.installOpenResearchIn": "Installera OpenResearch i {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Installera OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan OpenResearch kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan OpenResearch igen.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av OpenResearch ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till OpenResearch-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (openresearch.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, OpenResearch stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör OpenResearch-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för OpenResearch",
  ...
  "settings.general.row.appearance.description": "Anpassa hur OpenResearch ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om OpenResearch följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa OpenResearchs tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när OpenResearch startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av OpenResearch.",
