export const dict = {
  ...
  "desktop.recovery.loadFailed": "OpenResearch laadimine ebaõnnestus",
  "desktop.recovery.terminated": "OpenResearch aken suleti ootamatult",
  "desktop.recovery.unresponsive": "OpenResearch ei vasta",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.openresearchMissing": "openresearch pole sellesse distrosse installitud",
  "desktop.wsl.error.openresearchCannotRun": "openresearch on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OpenResearch värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.openresearch.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.openresearchGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid OpenResearch'is.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Külastage ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises OpenResearch.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis openresearch.json",
  ...
  "dialog.server.description": "Lülitage, millise OpenResearch serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpenResearch": "OpenResearch kontrollimine...",
  "wsl.onboarding.checkingOpenResearchIn": "OpenResearch kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "OpenResearch värskendamine...",
  "wsl.onboarding.updatingOpenResearchIn": "OpenResearch värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Värskenda OpenResearch jaotises {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Värskenda OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch on valmis {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch on valmis.",
  "wsl.onboarding.installOpenResearchIn": "Installige OpenResearch asukohta {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Installige OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui OpenResearch saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse OpenResearch ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast OpenResearch meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (openresearch.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, OpenResearch ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "OpenResearch Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage OpenResearch server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke OpenResearch kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas OpenResearch teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas OpenResearch järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas OpenResearch on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui OpenResearch käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse OpenResearch uusimat versiooni.",
