export const dict = {
  ...
  "desktop.menu.documentation": "OpenResearch-documentatie",
  ...
  "desktop.recovery.loadFailed": "OpenResearch kan niet worden geladen",
  "desktop.recovery.terminated": "Het OpenResearch-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "OpenResearch reageert niet",
  ...
  "desktop.wsl.error.installOpenResearch": "Installatie van OpenResearch is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.openresearchMissing": "openresearch is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.openresearchCannotRun": "openresearch is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De OpenResearch-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.openresearch.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.openresearchGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in OpenResearch te gebruiken.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Ga naar ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in OpenResearch te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in OpenResearch te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in openresearch.json",
  ...
  "dialog.server.description": "Wijzig met welke OpenResearch-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpenResearch": "OpenResearch controleren...",
  "wsl.onboarding.checkingOpenResearchIn": "OpenResearch controleren in {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "OpenResearch bijwerken...",
  "wsl.onboarding.updatingOpenResearchIn": "OpenResearch bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Werk OpenResearch bij in {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "OpenResearch bijwerken",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch is gereed in {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch is klaar.",
  "wsl.onboarding.installOpenResearchIn": "Installeer OpenResearch in {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Installeer OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat OpenResearch een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens OpenResearch opnieuw.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van OpenResearch ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het OpenResearch-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (openresearch.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: OpenResearch ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de OpenResearch-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor OpenResearch",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe OpenResearch eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of OpenResearch het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van OpenResearch aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer OpenResearch wordt gestart",
  ...
  "settings.updates.toast.latest.title": "OpenResearch is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van OpenResearch.",
