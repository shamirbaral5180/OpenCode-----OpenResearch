export const dict = {
  ...
  "desktop.recovery.loadFailed": "OpenResearch gagal dimuat",
  "desktop.recovery.terminated": "Jendela OpenResearch berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "OpenResearch tidak merespons",
  ...
  "desktop.wsl.error.installOpenResearch": "Instalasi OpenResearch gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.openresearchMissing": "openresearch belum terinstal di distro ini",
  "desktop.wsl.error.openresearchCannotRun": "openresearch telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan OpenResearch selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.openresearch.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.openresearchGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di OpenResearch.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di openresearch.json",
  ...
  "dialog.server.description": "Ganti server OpenResearch mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Memeriksa OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Memeriksa OpenResearch di {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Memperbarui OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Memperbarui OpenResearch di {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Perbarui OpenResearch di {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Perbarui OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch siap di {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch siap.",
  "wsl.onboarding.installOpenResearchIn": "Instal OpenResearch di {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Instal OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum OpenResearch dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru OpenResearch ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim OpenResearch",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (openresearch.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: OpenResearch belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server OpenResearch di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk OpenResearch",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan OpenResearch di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah OpenResearch mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat OpenResearch diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru OpenResearch.",
