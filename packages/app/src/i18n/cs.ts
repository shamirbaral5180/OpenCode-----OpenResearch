export const dict = {
  ...
  "desktop.menu.documentation": "OpenResearch Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka OpenResearch",
  ...
  "desktop.recovery.loadFailed": "OpenResearch se nepodařilo načíst",
  "desktop.recovery.terminated": "OpenResearch okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "OpenResearch nereaguje",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.openresearchMissing": "openresearch není v této distribuci nainstalováno",
  "desktop.wsl.error.openresearchCannotRun": "openresearch je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OpenResearch aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.openresearch.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.openresearchGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Návštěva ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v OpenResearch.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v openresearch.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému OpenResearch serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Kontrola OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Kontrola OpenResearch v {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Aktualizace OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Aktualizace OpenResearch v {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Aktualizace OpenResearch v {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Aktualizovat OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch je připraveno v {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch je připraven.",
  "wsl.onboarding.installOpenResearchIn": "Nainstalujte OpenResearch do {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Instalovat OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než OpenResearch může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze OpenResearch ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu OpenResearch",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (openresearch.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: OpenResearch zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server OpenResearch uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro OpenResearch",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled OpenResearch na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude OpenResearch následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma OpenResearch.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění OpenResearch",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi OpenResearch.",
