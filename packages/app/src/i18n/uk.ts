export const dict = {
  ...
  "desktop.menu.documentation": "Документація OpenResearch",
  ...
  "desktop.menu.ariaLabel": "Меню OpenResearch",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити OpenResearch",
  "desktop.recovery.terminated": "Роботу вікна OpenResearch несподівано завершено",
  "desktop.recovery.unresponsive": "OpenResearch не відповідає",
  ...
  "desktop.wsl.error.installOpenResearch": "Не вдалося встановити OpenResearch",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.openresearchMissing": "openresearch не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.openresearchCannotRun": "openresearch встановлено, але його не вдалося запустити",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення OpenResearch завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.openresearch.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.openresearchGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Відвідайте ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у OpenResearch.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в openresearch.json",
  ...
  "dialog.server.description": "Перемкніть сервер OpenResearch, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Перевірка OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Перевірка OpenResearch у {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Оновлення OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Оновлення OpenResearch у {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Оновіть OpenResearch у {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Оновити OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch готовий до роботи у {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch готовий до роботи.",
  "wsl.onboarding.installOpenResearchIn": "Встановіть OpenResearch у {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Встановити OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в OpenResearch потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія OpenResearch ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді OpenResearch",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (openresearch.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, OpenResearch ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер OpenResearch всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу OpenResearch",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд OpenResearch на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи OpenResearch використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему OpenResearch.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску OpenResearch",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію OpenResearch.",
