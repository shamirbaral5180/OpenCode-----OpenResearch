export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de OpenResearch",
  ...
  "desktop.menu.ariaLabel": "Menú de OpenResearch",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar OpenResearch",
  "desktop.recovery.terminated": "La ventana de OpenResearch se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "OpenResearch no responde",
  ...
  "desktop.wsl.error.installOpenResearch": "No se pudo instalar OpenResearch",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.openresearchMissing": "openresearch no está instalado en esta distribución",
  "desktop.wsl.error.openresearchCannotRun": "openresearch está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de OpenResearch finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.openresearch.tagline": "Modelos optimizados y fiables",
  "dialog.provider.openresearchGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.openresearchZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en OpenResearch.",
  ...
  "dialog.plugins.empty": "Plugins configurados en openresearch.json",
  ...
  "dialog.server.description": "Cambiar el servidor de OpenResearch al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Comprobando OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Comprobando OpenResearch en {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Actualizando OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Actualizando OpenResearch en {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Actualiza OpenResearch en {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Actualizar OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch está listo en {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch está listo.",
  "wsl.onboarding.installOpenResearchIn": "Instala OpenResearch en {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Instalar OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que OpenResearch pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de OpenResearch ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de OpenResearch",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (openresearch.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: OpenResearch aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor OpenResearch dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para OpenResearch",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve OpenResearch en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si OpenResearch sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de OpenResearch.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia OpenResearch",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de OpenResearch.",
