export const dict = {
  ...
  "desktop.menu.documentation": "OpenResearch دستاویزات",
  ...
  "desktop.menu.ariaLabel": "OpenResearch مینو",
  ...
  "desktop.recovery.loadFailed": "OpenResearch لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "OpenResearch ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "OpenResearch جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.openresearchMissing": "اس ڈسٹری بیوشن میں openresearch انسٹال نہیں ہے",
  "desktop.wsl.error.openresearchCannotRun": "openresearch انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.openresearchNotInstalled": "{{distro}} میں OpenResearch انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "OpenResearch کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.openresearch.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.openresearch.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.openresearchGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenResearch کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور OpenResearch میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.openresearchZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور OpenResearch میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور OpenResearch میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "openresearch.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس OpenResearch سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpenResearch": "OpenResearch چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpenResearchIn": "{{distro}} میں OpenResearch چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpenResearch": "OpenResearch کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpenResearchIn": "{{distro}} میں OpenResearch کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpenResearchIn": "{{distro}} میں OpenResearch کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpenResearch": "OpenResearch کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch {{distro}} میں تیار ہے۔",
  "wsl.onboarding.openresearchReady": "OpenResearch تیار ہے۔",
  "wsl.onboarding.installOpenResearchIn": "{{distro}} میں OpenResearch انسٹال کریں۔",
  "wsl.onboarding.installOpenResearch": "OpenResearch انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ OpenResearch WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر OpenResearch کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "OpenResearch Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OpenResearch ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم OpenResearch ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (openresearch.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، OpenResearch ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "OpenResearch ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر OpenResearch سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "OpenResearch کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر OpenResearch کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا OpenResearch سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "OpenResearch کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "OpenResearch لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ OpenResearch کا تازہ ترین ورژن چلا رہے ہیں۔",
