export const dict = {
  ...
  "desktop.menu.documentation": "OpenResearch Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "OpenResearch μενού",
  ...
  "desktop.recovery.loadFailed": "OpenResearch απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "OpenResearch το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "OpenResearch δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.openresearchMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.openresearchCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OpenResearch η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.openresearch.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  "dialog.provider.openresearchGo.tagline": "Συνδρομή χαμηλού κόστους για όλους",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  "provider.connect.oauth.code.visit.prefix": "Επίσκεψη ",
  "provider.connect.oauth.code.visit.link": "αυτός ο σύνδεσμος",
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο OpenResearch.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο openresearch.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή OpenResearch συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Έλεγχος OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Έλεγχος OpenResearch σε {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Ενημέρωση OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Ενημέρωση OpenResearch σε {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Ενημέρωση OpenResearch σε {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Ενημέρωση OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch είναι έτοιμο.",
  "wsl.onboarding.installOpenResearchIn": "Εγκατάσταση του OpenResearch στο {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Εγκατάσταση OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο OpenResearch να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του OpenResearch ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα OpenResearch",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (openresearch.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το OpenResearch δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "OpenResearch Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή OpenResearch μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το OpenResearch",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του OpenResearch στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το OpenResearch ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το OpenResearch.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του OpenResearch",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του OpenResearch.",
