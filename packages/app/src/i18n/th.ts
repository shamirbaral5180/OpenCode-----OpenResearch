export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด OpenResearch ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง OpenResearch หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "OpenResearch ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installOpenResearch": "การติดตั้ง OpenResearch ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.openresearchMissing": "ไม่ได้ติดตั้ง openresearch ในดิสโทรนี้",
  "desktop.wsl.error.openresearchCannotRun": "ติดตั้ง openresearch แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.openresearchNotInstalled": "ไม่ได้ติดตั้ง OpenResearch ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต OpenResearch เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.provider.openresearch.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.openresearch.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.openresearchGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน OpenResearch",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  "provider.connect.openresearchZen.line2":
    "ด้วยคีย์ API เดียวคุณจะได้รับการเข้าถึงโมเดล เช่น Claude, GPT, Gemini, GLM และอื่น ๆ",
  "provider.connect.openresearchZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " เพื่อรับคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน OpenResearch",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน OpenResearch",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน openresearch.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ OpenResearch ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpenResearch": "กำลังตรวจสอบ OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "กำลังตรวจสอบ OpenResearch ใน {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "กำลังอัปเดต OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "กำลังอัปเดต OpenResearch ใน {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "อัปเดต OpenResearch ใน {{distro}}",
  "wsl.onboarding.updateOpenResearch": "อัปเดต OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.openresearchReady": "OpenResearch พร้อมใช้งานแล้ว",
  "wsl.onboarding.installOpenResearchIn": "ติดตั้ง OpenResearch ใน {{distro}}",
  "wsl.onboarding.installOpenResearch": "ติดตั้ง OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "ยังไม่ได้ติดตั้ง OpenResearch",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ OpenResearch จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด OpenResearch อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ OpenResearch Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ OpenResearch ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม OpenResearch",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (openresearch.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า OpenResearch ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ OpenResearch ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ OpenResearch",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ OpenResearch บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ OpenResearch ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ OpenResearch",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ OpenResearch เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน OpenResearch เวอร์ชันล่าสุด",
