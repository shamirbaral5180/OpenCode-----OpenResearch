...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OpenResearch yüklenemedi",
  "desktop.recovery.terminated": "OpenResearch penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "OpenResearch yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.openresearchMissing": "openresearch bu dağıtımda kurulu değil",
  "desktop.wsl.error.openresearchCannotRun": "openresearch kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "OpenResearch güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.openresearch.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.openresearchGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenResearch tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OpenResearch'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.openresearchZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak OpenResearch'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OpenResearch'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler openresearch.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OpenResearch sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpenResearch": "OpenResearch kontrol ediliyor...",
  "wsl.onboarding.checkingOpenResearchIn": "{{distro}} içinde OpenResearch kontrol ediliyor...",
  "wsl.onboarding.updatingOpenResearch": "OpenResearch güncelleniyor...",
  "wsl.onboarding.updatingOpenResearchIn": "{{distro}} içinde OpenResearch güncelleniyor...",
  "wsl.onboarding.updateOpenResearchIn": "{{distro}} içindeki OpenResearch'u güncelleyin.",
  "wsl.onboarding.updateOpenResearch": "OpenResearch'u güncelle",
  "wsl.onboarding.openresearchReadyIn": "{{distro}} içinde OpenResearch hazır.",
  "wsl.onboarding.openresearchReady": "OpenResearch hazır.",
  "wsl.onboarding.installOpenResearchIn": "OpenResearch'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpenResearch": "OpenResearch'u kur",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenResearch'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından OpenResearch'u tekrar açın.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OpenResearch'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı OpenResearch ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (openresearch.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: OpenResearch henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "OpenResearch Masaüstü",
  ...
  "settings.desktop.wsl.description": "OpenResearch sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "OpenResearch'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "OpenResearch'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OpenResearch'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OpenResearch'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OpenResearch başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OpenResearch'un en son sürümünü kullanıyorsunuz.",
