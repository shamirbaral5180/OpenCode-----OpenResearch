export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za OpenResearch",
  ...
  "desktop.menu.ariaLabel": "OpenResearch meni",
  ...
  "desktop.recovery.loadFailed": "OpenResearch se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor OpenResearch-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "OpenResearch ne reaguje",
  ...
  "desktop.wsl.error.installOpenResearch": "Instalacija OpenResearch-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.openresearchMissing": "openresearch nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.openresearchCannotRun": "openresearch je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje OpenResearch-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.openresearch.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.openresearchGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OpenResearch-u.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Posjeti ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OpenResearch-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OpenResearch-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u openresearch.json",
  ...
  "dialog.server.description": "Promijeni na koji se OpenResearch server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Provjera OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Provjera OpenResearch u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Ažuriranje OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Ažuriranje OpenResearch u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Ažuriraj OpenResearch u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Ažuriraj OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch je spreman.",
  "wsl.onboarding.installOpenResearchIn": "Instaliraj OpenResearch u distribuciji {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Instaliraj OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi OpenResearch mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija OpenResearch-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OpenResearch timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (openresearch.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OpenResearch još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni OpenResearch server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OpenResearch-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako OpenResearch izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OpenResearch prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OpenResearch-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OpenResearch pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OpenResearch-a.",
