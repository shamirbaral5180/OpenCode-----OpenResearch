export const dict = {
  ...
  "dialog.provider.openresearch.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.openresearch.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.openresearchGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.openresearchZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.openresearchZen.visit.prefix": "Visita ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in OpenResearch.",
  ...
  "dialog.plugins.empty": "Plugin configurati in openresearch.json",
  ...
  "dialog.server.description": "Cambia il server OpenResearch a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Controllo OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Controllo OpenResearch in {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Aggiornamento OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Aggiornamento OpenResearch in {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Aggiorna OpenResearch in {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Aggiorna OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch è pronto in {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch è pronto.",
  "wsl.onboarding.installOpenResearchIn": "Installa OpenResearch in {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Installa OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che OpenResearch possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di OpenResearch ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team OpenResearch",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (openresearch.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: OpenResearch non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server OpenResearch all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per OpenResearch",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di OpenResearch sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se OpenResearch segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di OpenResearch.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di OpenResearch",
  ...
  "settings.updates.toast.latest.title": "OpenResearch è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di OpenResearch.",
  ...
  "desktop.menu.documentation": "Documentazione di OpenResearch",
  ...
  "desktop.menu.ariaLabel": "Menu OpenResearch",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare OpenResearch",
  "desktop.recovery.terminated": "La finestra di OpenResearch si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "OpenResearch non risponde",
  ...
  "desktop.wsl.error.installOpenResearch": "Installazione di OpenResearch non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.openresearchMissing": "openresearch non è installato in questa distribuzione",
  "desktop.wsl.error.openresearchCannotRun": "openresearch è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di OpenResearch è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
