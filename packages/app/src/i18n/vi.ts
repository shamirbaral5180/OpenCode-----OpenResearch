export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu OpenResearch",
  ...
  "desktop.recovery.loadFailed": "Không tải được OpenResearch",
  "desktop.recovery.terminated": "Cửa sổ OpenResearch đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "OpenResearch không phản hồi",
  ...
  "desktop.wsl.error.installOpenResearch": "Không cài đặt được OpenResearch",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.openresearchMissing": "openresearch chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.openresearchCannotRun": "openresearch đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật OpenResearch nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.openresearch.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.openresearchGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do OpenResearch cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Truy cập ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong OpenResearch.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong openresearch.json",
  ...
  "dialog.server.description": "Chuyển máy chủ OpenResearch mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Đang kiểm tra OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Đang kiểm tra OpenResearch trong {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Đang cập nhật OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Đang cập nhật OpenResearch trong {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Cập nhật OpenResearch trong {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Cập nhật OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch đã sẵn sàng.",
  "wsl.onboarding.installOpenResearchIn": "Cài đặt OpenResearch trong {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Cài đặt OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi OpenResearch có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của OpenResearch ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm OpenResearch",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (openresearch.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: OpenResearch chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ OpenResearch bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho OpenResearch",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của OpenResearch trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem OpenResearch tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của OpenResearch.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi OpenResearch khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của OpenResearch.",
