export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do OpenResearch",
  ...
  "desktop.menu.ariaLabel": "Menu do OpenResearch",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o OpenResearch",
  "desktop.recovery.terminated": "A janela do OpenResearch foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O OpenResearch não está respondendo",
  ...
  "desktop.wsl.error.installOpenResearch": "Falha na instalação do OpenResearch",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.openresearchMissing": "O openresearch não está instalado nesta distribuição",
  "desktop.wsl.error.openresearchCannotRun": "O openresearch está instalado, mas não pôde ser executado",
  "desktop.wsl.error.openresearchNotInstalled": "O OpenResearch não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do OpenResearch foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.openresearch.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.openresearchGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Visite ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no OpenResearch.",
  ...
  "dialog.plugins.empty": "Plugins configurados em openresearch.json",
  ...
  "dialog.server.description": "Trocar para qual servidor OpenResearch este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Verificando o OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Verificando o OpenResearch em {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Atualizando o OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Atualizando o OpenResearch em {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Atualize o OpenResearch em {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Atualizar o OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "O OpenResearch está pronto em {{distro}}.",
  "wsl.onboarding.openresearchReady": "O OpenResearch está pronto.",
  "wsl.onboarding.installOpenResearchIn": "Instale o OpenResearch em {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Instalar o OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o OpenResearch possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O OpenResearch não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o OpenResearch novamente.",
  ...
  "help.tabs.introduction": "Agora, o OpenResearch Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do OpenResearch ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do OpenResearch",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (openresearch.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: OpenResearch ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor OpenResearch dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do OpenResearch",
  ...
  "settings.general.row.appearance.description": "Personalize como o OpenResearch aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o OpenResearch segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o OpenResearch é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o OpenResearch iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do OpenResearch.",
