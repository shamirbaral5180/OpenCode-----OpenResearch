export const dict = {
  ...
  "desktop.recovery.loadFailed": "OpenResearchを読み込めませんでした",
  "desktop.recovery.terminated": "OpenResearchのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "OpenResearchが応答していません",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearchのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.openresearchMissing": "このディストリビューションにはopenresearchがインストールされていません",
  "desktop.wsl.error.openresearchCannotRun": "openresearchはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.openresearchNotInstalled": "{{distro}}にはOpenResearchがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "OpenResearchのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.openresearch.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.openresearch.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.openresearchGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenResearchが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、OpenResearchで{{provider}}モデルを使用します。",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.openresearchZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.openresearchZen.visit.prefix": " ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してOpenResearchで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、OpenResearchで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "openresearch.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するOpenResearchサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpenResearch": "OpenResearchを確認中...",
  "wsl.onboarding.checkingOpenResearchIn": "{{distro}}内のOpenResearchを確認中...",
  "wsl.onboarding.updatingOpenResearch": "OpenResearchを更新中...",
  "wsl.onboarding.updatingOpenResearchIn": "{{distro}}内のOpenResearchを更新中...",
  "wsl.onboarding.updateOpenResearchIn": "{{distro}}内のOpenResearchを更新してください。",
  "wsl.onboarding.updateOpenResearch": "OpenResearchを更新",
  "wsl.onboarding.openresearchReadyIn": "{{distro}}内のOpenResearchの準備ができました。",
  "wsl.onboarding.openresearchReady": "OpenResearchの準備ができました。",
  "wsl.onboarding.installOpenResearchIn": "{{distro}}にOpenResearchをインストールしてください。",
  "wsl.onboarding.installOpenResearch": "OpenResearchをインストール",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearchがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenResearchでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、OpenResearchをもう一度開いてください。",
  ...
  "help.tabs.introduction": "OpenResearch Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OpenResearchの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをOpenResearchチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (openresearch.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: OpenResearchはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "OpenResearchには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でOpenResearchサーバーを実行します。",
  ...
  "settings.general.row.language.description": "OpenResearchの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのOpenResearchの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "OpenResearchがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "OpenResearchのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "OpenResearch の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "OpenResearch は最新バージョンです。",
