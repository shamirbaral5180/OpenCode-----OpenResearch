export const dict = {
  ...
  "desktop.menu.documentation": "OpenResearch Skjøl",
  ...
  "desktop.menu.ariaLabel": "OpenResearch valmynd",
  ...
  "desktop.recovery.loadFailed": "OpenResearch miseydnaðist at heinta",
  "desktop.recovery.terminated": "OpenResearch vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "OpenResearch svarar ikki",
  ...
  "desktop.wsl.error.installOpenResearch": "OpenResearch uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.openresearchMissing": "openresearch er ikki sett upp í hesi distro",
  "desktop.wsl.error.openresearchCannotRun": "openresearch er sett upp men kundi ikki koyra",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OpenResearch dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.openresearch.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.openresearch.tagline": "Álítandi optimerað modell",
  "dialog.provider.openresearchGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Vitja ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í OpenResearch.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í openresearch.json",
  ...
  "dialog.server.description": "Skift hvønn OpenResearch ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Kanna OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Kanna OpenResearch í {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Dagføring OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Dagføring OpenResearch í {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Dagfør OpenResearch í {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Dagfør OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch er klárt í {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch er klárt.",
  "wsl.onboarding.installOpenResearchIn": "Set OpenResearch upp í {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Set upp OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn OpenResearch kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani OpenResearch aftur.",
  ...
  "help.tabs.introduction": "OpenResearch Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av OpenResearch ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til OpenResearch toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (openresearch.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, OpenResearch stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "OpenResearch Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr OpenResearch ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri OpenResearch",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu OpenResearch sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um OpenResearch fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu OpenResearch er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá OpenResearch byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av OpenResearch.",
