export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja OpenResearch",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać OpenResearch",
  "desktop.recovery.terminated": "Okno OpenResearch zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "OpenResearch nie odpowiada",
  ...
  "desktop.wsl.error.installOpenResearch": "Nie udało się zainstalować OpenResearch",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.openresearchMissing": "Program openresearch nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.openresearchCannotRun": "Program openresearch jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja OpenResearch została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.openresearch.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.openresearchGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Odwiedź ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenResearch.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku openresearch.json",
  ...
  "dialog.server.description": "Przełącz serwer OpenResearch, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Sprawdzanie OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Sprawdzanie OpenResearch w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "Aktualizowanie OpenResearch...",
  "wsl.onboarding.updatingOpenResearchIn": "Aktualizowanie OpenResearch w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Zaktualizuj OpenResearch w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Zaktualizuj OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch jest gotowy.",
  "wsl.onboarding.installOpenResearchIn": "Zainstaluj OpenResearch w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Zainstaluj OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim OpenResearch będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja OpenResearch ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenResearch",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (openresearch.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: OpenResearch nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "OpenResearch zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer OpenResearch wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenResearch",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenResearch na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OpenResearch ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenResearch.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenResearch",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenResearch.",
