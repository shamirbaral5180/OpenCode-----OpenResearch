export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni OpenResearch",
  ...
  "desktop.menu.ariaLabel": "Menuja OpenResearch",
  ...
  "desktop.recovery.loadFailed": "OpenResearch nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja OpenResearch u mbyll papritur",
  "desktop.recovery.unresponsive": "OpenResearch nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpenResearch": "Instalimi i OpenResearch dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.openresearchMissing": "OpenResearch nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.openresearchCannotRun": "OpenResearch është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.openresearchNotInstalled": "OpenResearch nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i OpenResearch përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.openresearch.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.openresearch.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.openresearchGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në OpenResearch.",
  ...
  "provider.connect.openresearchZen.line1":
    "OpenResearch Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.openresearchZen.visit.prefix": "Vizitoni ",
  "provider.connect.openresearchZen.visit.link": "openresearch.ai/zen",
  "provider.connect.openresearchZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në OpenResearch.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në openresearch.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server OpenResearch lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpenResearch": "Po kontrollon OpenResearch...",
  "wsl.onboarding.checkingOpenResearchIn": "Po kontrollon OpenResearch në {{distro}}...",
  "wsl.onboarding.updatingOpenResearch": "OpenResearch po përditësohet...",
  "wsl.onboarding.updatingOpenResearchIn": "Po përditëson OpenResearch në {{distro}}...",
  "wsl.onboarding.updateOpenResearchIn": "Përditëso OpenResearch në {{distro}}.",
  "wsl.onboarding.updateOpenResearch": "Përditëso OpenResearch",
  "wsl.onboarding.openresearchReadyIn": "OpenResearch është gati në {{distro}}.",
  "wsl.onboarding.openresearchReady": "OpenResearch është gati.",
  "wsl.onboarding.installOpenResearchIn": "Instaloni OpenResearch në {{distro}}.",
  "wsl.onboarding.installOpenResearch": "Instaloni OpenResearch",
  ...
  "wsl.onboarding.distroStatus.openresearchMissing": "OpenResearch nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se OpenResearch të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "OpenResearch nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap OpenResearch.",
  ...
  "help.tabs.introduction": "OpenResearch Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i OpenResearch ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i OpenResearch",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (openresearch.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, OpenResearch nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin OpenResearch brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për OpenResearch",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket OpenResearch në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse OpenResearch ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e OpenResearch.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset OpenResearch",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të OpenResearch.",
