...
import type { AgentPartInput, FilePartInput, OpenResearchClient, Session, TextPartInput } from "@openresearch-ai/sdk/v2/client"
import type {
  Project,
  ProjectCurrent,
  SessionApi,
...
type LegacyClient = OpenResearchClient
