import type { Message, Part, Session } from "@openresearch-ai/sdk/v2/client"

// Matches the exact `{ info, messages: [{ info, parts }] }` structure produced by `openresearch export` CLI
