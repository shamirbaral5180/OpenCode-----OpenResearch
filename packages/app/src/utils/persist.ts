...
const GLOBAL_STORAGE = "openresearch.global.dat"
const WINDOW_STORAGE = "openresearch.window"
const LOCAL_PREFIX = "openresearch."
...
function workspaceStorage(dir: string) {
  ...
  return `openresearch.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `openresearch.draft.${head}.${sum}.dat`
}
