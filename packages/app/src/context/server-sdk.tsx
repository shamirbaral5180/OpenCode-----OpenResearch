import type { OpenResearchEvent } from "@openresearch-ai/client/promise"
import type { Event } from "@openresearch-ai/sdk/v2/client"
...
export type ServerEvent = Event & { current?: OpenResearchEvent }
...
export function adaptServerEvent(event: OpenResearchEvent): ServerEvent {
...
function currentDelta(event: OpenResearchEvent | undefined): CurrentDelta | undefined {
  if (
