import type { OpenResearchEvent, SessionMessageInfo, SessionPendingMessage } from "@openresearch-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: OpenResearchEvent): V2SessionReduction | undefined => {
