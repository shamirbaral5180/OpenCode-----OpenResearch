import type { SessionApi } from "@openresearch-ai/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { OpenResearchClient } from "@openresearch-ai/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: OpenResearchClient; directory: string; limit: number }) {
  try {
