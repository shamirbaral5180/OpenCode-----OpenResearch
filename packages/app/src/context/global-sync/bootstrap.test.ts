...
import type { Config, OpenResearchClient, Project } from "@openresearch-ai/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@openresearch-ai/client/promise"
import type { NormalizedProviderListResponse } from "@openresearch-ai/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
