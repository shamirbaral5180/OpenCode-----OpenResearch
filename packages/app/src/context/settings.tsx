...
export const { use: useSettings, provider: SettingsProvider } = createSimpleContext({
  name: "Settings",
  gate: false,
  init: () => createSettings(usePlatform()),
})

export function createSettings(platform: Platform) {
  ...
  const showCustomAgents = withFallback(() => store.general?.showCustomAgents, defaultSettings.general.showCustomAgents)
  ...
  // Research keeps the legacy interface regardless of saved preferences, version, or date.
  const newLayoutDesigns = () => newLayoutDesignsDefault
  ...
  return {
    ...
    general: {
      ...
      newLayoutDesigns,
      setNewLayoutDesigns(_value: boolean) {
