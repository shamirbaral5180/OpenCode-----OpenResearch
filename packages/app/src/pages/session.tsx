import type { FilePart, Project, UserMessage, VcsFileDiff } from "@openresearch-ai/sdk/v2"
import { getFilename } from "@openresearch-ai/core/util/path"
...
import type { SessionReviewLineComment } from "@openresearch-ai/session-ui/session-review"
import { ResizeHandle } from "@openresearch-ai/ui/resize-handle"
import { Select } from "@openresearch-ai/ui/select"
import { SelectV2 } from "@openresearch-ai/ui/v2/select-v2"
import { isScrollKeyTarget, scrollKey, scrollKeyOwner } from "@openresearch-ai/ui/scroll-view"
import { Tabs } from "@openresearch-ai/ui/tabs"
import { ButtonV2 } from "@openresearch-ai/ui/v2/button-v2"
import { createAutoScroll } from "@openresearch-ai/ui/hooks"
import { previewSelectedLines } from "@openresearch-ai/session-ui/pierre/selection-bridge"
import { Button } from "@openresearch-ai/ui/button"
import { showToast } from "@/utils/toast"
import { base64Encode, checksum } from "@openresearch-ai/core/util/encode"
...
import { SessionReviewEmptyChangesV2 } from "@openresearch-ai/session-ui/v2/session-review-empty-changes-v2"
import { SessionReviewEmptyNoGitV2 } from "@openresearch-ai/session-ui/v2/session-review-empty-no-git-v2"
import { SessionReviewV2SidebarToggle } from "@openresearch-ai/session-ui/v2/session-review-v2"
