...
import { base64Encode } from "@openresearch-ai/core/util/encode"
...
import { Session } from "@openresearch-ai/sdk/v2/client"
...
import { retry } from "@openresearch-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@openresearch-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://openresearch.ai/desktop-feedback")}
      renderPanel={() =>
