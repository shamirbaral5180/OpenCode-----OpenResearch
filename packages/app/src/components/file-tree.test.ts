...
beforeAll(async () => {
  ...
  mock.module("@openresearch-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openresearch-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openresearch-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openresearch-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
