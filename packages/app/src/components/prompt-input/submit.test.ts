...
beforeAll(async () => {
  ...
  mock.module("@openresearch-ai/sdk/v2/client", () => ({
    createOpenResearchClient: (input: { directory: string }) => {
      createdClients.push(input.directory)
      return clientFor(input.directory)
    },
  }))

  mock.module("@openresearch-ai/ui/toast", () => ({
    Toast: { Region: () => null },
    showToast: () => 0,
  }))

  mock.module("@openresearch-ai/core/util/encode", () => ({
