import { withAlpha } from "@openresearch-ai/ui/theme/color"
import { useTheme } from "@openresearch-ai/ui/theme/context"
import { resolveThemeVariant } from "@openresearch-ai/ui/theme/resolve"
import { resolveThemeVariantV2 } from "@openresearch-ai/ui/theme/v2/resolve"
import type { HexColor, ResolvedV2Theme } from "@openresearch-ai/ui/theme/types"
...
export const Terminal = (props: TerminalProps) => {
  ...
  const username = auth?.username ?? "openresearch"
        ...
        if ((await sdk().protocol) === "v1") {
          const result = await sdk()
            .client.pty.connectToken(
              ...
              {
                throwOnError: false,
                headers: { "x-openresearch-ticket": "1" },
              },
            )
            .catch((err: unknown) => {
