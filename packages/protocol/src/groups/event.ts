...
import type { Definition } from "@openresearch-ai/schema/event"
...
export const OpenResearchEvent = event.schema
export type OpenResearchEvent = typeof OpenResearchEvent.Type
export type OpenResearchEventEncoded = typeof OpenResearchEvent.Encoded
