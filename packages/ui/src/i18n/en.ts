export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Subscribe to OpenResearch Go for reliable access to the best open-source models for $10/month.",
  ...
  "ui.promptInput.placeholder.normal":
    "Ask a research question, {{slash}} for commands, {{at}} for sources and context...",
