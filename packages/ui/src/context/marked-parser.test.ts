...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[OpenResearch](https://openresearch.ai)")).toBe(
    '<p><a href="https://openresearch.ai" class="external-link" target="_blank" rel="noopener noreferrer">OpenResearch</a></p>\n',
  )
})
