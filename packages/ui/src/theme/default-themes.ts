...
import openresearchThemeJson from "./themes/openresearch.json"
...
export const openresearchTheme = openresearchThemeJson as DesktopTheme
...
export const DEFAULT_THEMES: Record<string, DesktopTheme> = {
  ...
  openresearch: openresearchTheme,
  orng: orngTheme,
