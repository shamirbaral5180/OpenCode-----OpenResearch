...
const STORAGE_KEYS = {
  THEME_ID: "openresearch-theme-id",
  COLOR_SCHEME: "openresearch-color-scheme",
  THEME_CSS_LIGHT: "openresearch-theme-css-light",
  THEME_CSS_DARK: "openresearch-theme-css-dark",
} as const
