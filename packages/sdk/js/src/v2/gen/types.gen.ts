...
/**
 * Server configuration for openresearch serve and web commands
 */
...
export type SessionModelInputData = {
  body?: never
  path: {
    sessionID: string
  }
...
export type SessionModelInputErrors = {
  /**
   * BadRequest | InvalidRequestError
   */
  400: EffectHttpApiErrorBadRequest | InvalidRequestError
...
export type SessionModelInputError = SessionModelInputErrors[keyof SessionModelInputErrors]

export type SessionModelInputResponses = {
  /**
   * Latest model input
   */
  200: ModelInputSnapshot
}

export type SessionModelInputResponse = SessionModelInputResponses[keyof SessionModelInputResponses]
