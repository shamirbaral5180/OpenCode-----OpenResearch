...
import type {
  ...
  SessionModelInputErrors,
  SessionModelInputResponses,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new OpenResearchClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the OpenResearch system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the OpenResearch system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the OpenResearch server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local OpenResearch state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global OpenResearch configuration settings and preferences.
   */
   ...
   *
   * Update global OpenResearch configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the OpenResearch server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the OpenResearch system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all OpenResearch instances, releasing all resources.
   */
  ...
  /**
   * Upgrade openresearch
   *
   * Upgrade openresearch to the specified version.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current OpenResearch configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update OpenResearch configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current OpenResearch instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the OpenResearch system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with OpenResearch.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that OpenResearch is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by OpenResearch.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all OpenResearch sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new OpenResearch session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific OpenResearch session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
  ...
  /**
   * Get latest model input
   *
   * Inspect the latest sanitized model input captured for a session.
   */
  public modelInput<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
      directory?: string
      workspace?: string
    ...
    return (options?.client ?? this.client).get<SessionModelInputResponses, SessionModelInputErrors, ThrowOnError>({
      url: "/session/{sessionID}/model-input",
      ...options,
      ...params,
    })
  }
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Interrupt active execution owned by this OpenResearch process. Idle interruption is a no-op.
   */
...
export class OpenResearchClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<OpenResearchClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    OpenResearchClient.__registry.set(this, args?.key)
  }
