...
- Effect plugins import `@openresearch-ai/plugin/v2/effect`, not `@openresearch-ai/core`.
- Public domain values use generated `@openresearch-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@openresearch-ai/plugin/v2/effect`.
