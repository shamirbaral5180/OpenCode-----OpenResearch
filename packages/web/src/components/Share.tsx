...
import { IconOpenResearch } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "openresearch/session/message-v2"
import type { Message } from "openresearch/session/message"
import type { Session } from "openresearch/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.openresearch_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.openresearch_name}>
                    <IconOpenResearch width={16} height={16} />
                  </div>
