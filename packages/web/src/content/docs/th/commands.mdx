...
สร้าง `.openresearch/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ OpenResearch:
...
- ระดับผู้ใช้ (Global): `~/.config/openresearch/commands/`
- ระดับโปรเจ็กต์: `.openresearch/commands/`
...
OpenResearch มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
