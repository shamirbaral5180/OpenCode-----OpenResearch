...
Opret `.openresearch/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem OpenResearch-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din OpenResearch [config](/docs/config):
...
- Globalt: `~/.config/openresearch/commands/`
- Pr. projekt: `.openresearch/commands/`
...
openresearch indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
