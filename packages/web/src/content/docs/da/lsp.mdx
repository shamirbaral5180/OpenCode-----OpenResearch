---
title: LSP-servere
description: OpenResearch integreres med dine LSP-servere.
---

OpenResearch kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

OpenResearch leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `OPENRESEARCH_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og openresearch åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din openresearch-konfiguration.
