...
Brug den til at bygge integrasjoner og kontrollere openresearch programmatisk.
...
Opret en forekomst av openresearch:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `openresearch.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av openresearch, kan du oprete en klientforekomst for at koble til den:
