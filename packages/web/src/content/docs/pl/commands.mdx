...
Utwórz `.openresearch/commands/test.md`:
...
Możesz zdefiniować polecenia w `openresearch.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji openresearch:
...
- Globalnie: `~/.config/openresearch/commands/`
- Na projekt: `.openresearch/commands/`
...
openresearch zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
