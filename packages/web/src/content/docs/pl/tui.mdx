---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala openresearch.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

openresearch zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie openresearch uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI openresearch, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do openresearch. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij openresearch. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `openresearch.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo OpenResearch czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `openresearch.default`.
