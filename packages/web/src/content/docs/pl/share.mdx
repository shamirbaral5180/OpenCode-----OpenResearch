---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące openresearch.
---

Funkcja udostępniania openresearch umożliwia tworzenie publicznych linków do konwersacji openresearch, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, openresearch:
...
openresearch obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie openresearch korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `openresearch.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu openresearch w Twojej organizacji.
