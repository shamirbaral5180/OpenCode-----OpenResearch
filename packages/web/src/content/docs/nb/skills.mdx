...
Agentferdigheter lar OpenResearch oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går openresearch opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
openresearch viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `openresearch.json`:
