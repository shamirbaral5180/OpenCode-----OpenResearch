...
Opprett `.openresearch/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom OpenResearch-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i OpenResearch [config](/docs/config):
...
- Per prosjekt: `.openresearch/commands/`
...
OpenResearch inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
