---
title: Deling
description: Del dine OpenResearch-samtaler.
---

Delingsfunksjonen i OpenResearch lar deg lage offentlige lenker til dine OpenResearch-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, OpenResearch:
...
OpenResearch støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker OpenResearch manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `openresearch.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av openresearch i organisasjonen din.
