...
description: Lag verktøy som LLM kan kalle inn OpenResearch.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med OpenResearch sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.openresearch/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/openresearch/tools/`.
