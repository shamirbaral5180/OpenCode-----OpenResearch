---
title: LSP-servere
description: openresearch integreres med LSP-serverne dine.
---

OpenResearch kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

OpenResearch kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `OPENRESEARCH_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og openresearch åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i OpenResearch-konfigurasjonen.
