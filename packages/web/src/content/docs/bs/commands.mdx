...
Kreiraj `.openresearch/commands/test.md`:
...
Možete dodati prilagođene komande kroz OpenResearch konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom OpenResearch [config](/docs/config):
...
- Globalno: `~/.config/openresearch/commands/`
- Po projektu: `.openresearch/commands/`
...
OpenResearch uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
