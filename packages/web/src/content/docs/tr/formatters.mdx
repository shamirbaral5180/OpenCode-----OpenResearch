...
description: openresearch dile özgü biçimlendiriciler kullanır.
---

openresearch, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

openresearch, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, openresearch bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

openresearch bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri openresearch yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
