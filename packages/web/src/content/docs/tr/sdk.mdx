---
title: SDK
description: openresearch sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

openresearch JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
openresearch'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir openresearch örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `openresearch.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir openresearch örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
