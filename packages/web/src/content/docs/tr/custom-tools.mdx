---
title: Özel Araçlar
description: LLM'un openresearch'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. openresearch'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.openresearch/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/openresearch/tools/` içine yerleştirerek.
