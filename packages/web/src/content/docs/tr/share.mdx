---
title: Paylasim
description: openresearch konusmalarini genel baglantilarla paylasin.
---

openresearch'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda openresearch:
...
openresearch, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak openresearch manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `openresearch.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda openresearch kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
