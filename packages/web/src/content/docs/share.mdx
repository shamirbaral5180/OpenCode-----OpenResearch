---
title: Share
description: Share your OpenResearch conversations.
---

OpenResearch's share feature allows you to create public links to your OpenResearch conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, OpenResearch:
...
OpenResearch supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, OpenResearch uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `openresearch.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using openresearch in your organization.
