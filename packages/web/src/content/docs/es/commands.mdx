...
Crear `.openresearch/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración OpenResearch o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su OpenResearch [config](/docs/config):
...
- Por proyecto: `.openresearch/commands/`
...
openresearch incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
