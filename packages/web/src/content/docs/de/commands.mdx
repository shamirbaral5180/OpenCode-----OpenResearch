...
Erstellen Sie `.openresearch/commands/test.md`:

```md title=".openresearch/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die OpenResearch-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem OpenResearch [config](/docs/config):

```json title="openresearch.jsonc" {4-12}
{
...
- Global: `~/.config/openresearch/commands/`
- Pro Projekt: `.openresearch/commands/`

```markdown title="~/.config/openresearch/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".openresearch/commands/component.md"
---
...
```md title=".openresearch/commands/create-file.md"
---
...
```md title=".openresearch/commands/analyze-coverage.md"
---
...
```md title=".openresearch/commands/review-changes.md"
---
...
```md title=".openresearch/commands/review-component.md"
---
...
OpenResearch enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
