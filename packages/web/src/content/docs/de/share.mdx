---
title: Teilen
description: Teile OpenResearch-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu OpenResearch-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht OpenResearch Folgendes:
...
OpenResearch hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt OpenResearch den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`openresearch.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du openresearch in deiner Organisation einsetzt.
