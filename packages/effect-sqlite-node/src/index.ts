...
export const TypeId: TypeId = "~@openresearch-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@openresearch-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@openresearch-ai/effect-sqlite-node/NodeSqliteClient")
