...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENRESEARCH.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/openresearch/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/openresearch (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/openresearch/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/openresearch/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const OPENRESEARCH_DB|OPENRESEARCH_DB|OPENRESEARCH_DEV|Global\\.Path\\.data|data =" in packages/openresearch/src (115 matches)',
  },
] as const
