...
import { useBindings, useOpenResearchModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useOpenResearchModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.OPENRESEARCH_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
