...
import defaultSoundPath from "@openresearch-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@openresearch-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@openresearch-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@openresearch-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@openresearch-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@openresearch-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "OpenResearch"
const DEFAULT_PACK_ID = "openresearch.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "OpenResearch Default",
  builtin: true,
  sounds: {
