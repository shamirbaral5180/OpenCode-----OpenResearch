...
import { OPENRESEARCH_BASE_MODE, useBindings, useCommandShortcut, useOpenResearchKeymap } from "../../keymap"
...
const GO_UPSELL_PROVIDERS = new Set(["openresearch", "openresearch-go"])
