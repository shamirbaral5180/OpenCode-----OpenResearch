...
import { registerOpenResearchSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@openresearch-ai/sdk/v2"
...
import { OPENRESEARCH_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useOpenResearchKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.OPENRESEARCH_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
