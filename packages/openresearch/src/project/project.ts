...
import { ProjectDirectoryTable, ProjectTable } from "@openresearch-ai/core/project/sql"
import { ProjectDirectories } from "@openresearch-ai/core/project/directories"
...
import { which } from "@openresearch-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.OPENRESEARCH_FAKE_VCS)
