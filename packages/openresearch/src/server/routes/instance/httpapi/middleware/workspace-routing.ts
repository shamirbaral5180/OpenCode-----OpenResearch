...
>()("@openresearch/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@openresearch/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.OPENRESEARCH_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.OPENRESEARCH_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-openresearch-directory"] || process.cwd()
}
