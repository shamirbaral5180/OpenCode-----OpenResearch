...
import { ModelInput } from "@/session/model-input"
...
export const SessionPaths = {
  ...
  modelInput: `${root}/:sessionID/model-input`,
  create: root,
...
export const SessionApi = HttpApi.make("session")
      ...
      .add(
        HttpApiEndpoint.get("list", SessionPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all OpenResearch sessions, sorted by most recently updated.",
          }),
        ),
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get session",
            description: "Retrieve detailed information about a specific OpenResearch session.",
          }),
        ),
        ...
        HttpApiEndpoint.get("modelInput", SessionPaths.modelInput, {
          params: { sessionID: SessionID },
          query: WorkspaceRoutingQuery,
          success: described(Schema.NullOr(ModelInput.Snapshot), "Latest model input"),
          error: [HttpApiError.BadRequest, ApiNotFoundError],
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "session.modelInput",
            summary: "Get latest model input",
            description: "Inspect the latest sanitized model input captured for a session.",
          }),
        ),
        HttpApiEndpoint.post("create", SessionPaths.create, {
          ...
          OpenApi.annotations({
            ...
            description: "Create a new OpenResearch session for interacting with AI assistants and managing conversations.",
          }),
        ),
  ...
  .annotateMerge(
    OpenApi.annotations({
      title: "openresearch experimental HttpApi",
      version: "0.0.1",
