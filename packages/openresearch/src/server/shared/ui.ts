...
export const LOCAL_UI_MESSAGE =
  "OpenResearch local UI is unavailable. Build this fork with an embedded web UI and enable it. Hosted upstream UI fallback is disabled."
...
export function embeddedUI(disableEmbeddedWebUi: boolean) {
  ...
  return (embeddedUIPromise ??=
    ...
    import("openresearch-web-ui.gen.ts").then((module) => module.default as Record<string, string>).catch(() => null))
}
