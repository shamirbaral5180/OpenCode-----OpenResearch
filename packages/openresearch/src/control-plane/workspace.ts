...
import { EventSequenceTable, EventTable } from "@openresearch-ai/core/event/sql"
...
import { WorkspaceEvent } from "@openresearch-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        OPENRESEARCH_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        OPENRESEARCH_WORKSPACE_ID: config.id,
        OPENRESEARCH_EXPERIMENTAL_WORKSPACES: "true",
