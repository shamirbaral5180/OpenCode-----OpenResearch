...
export class Service extends Context.Service<Service, Interface>()("@openresearch/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __OPENRESEARCH_PHOTON_WASM_PATH?: string }).__OPENRESEARCH_PHOTON_WASM_PATH =
