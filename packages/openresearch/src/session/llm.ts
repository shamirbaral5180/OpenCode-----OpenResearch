...
import { llmClient } from "@openresearch-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@openresearch-ai/llm"
import { LLMClient } from "@openresearch-ai/llm/route"
import type { LLMClientService } from "@openresearch-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via openresearch's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @openresearch-ai/llm. It
