...
import { buildPrompt } from "@openresearch-ai/core/session/compaction"
import { SessionCompactionEvent } from "@openresearch-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/SessionCompaction") {}
