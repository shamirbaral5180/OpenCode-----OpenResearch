...
import { MAX_STEPS_PROMPT } from "@openresearch-ai/core/session/runner/max-steps"
...
import { LLMEvent } from "@openresearch-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/SessionPrompt") {}
