import type { JsonSchema, LLMRequest, ProviderMetadata } from "@openresearch-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@openresearch-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @openresearch-ai/llm request objects from openresearch's session/AI SDK-shaped data.
  return LLM.request({
