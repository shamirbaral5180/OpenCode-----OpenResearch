...
export const prepare = Effect.fn("LLMRequestPrep.prepare")(function* (input: PrepareInput) {
  ...
  const openresearchProjectID = input.model.providerID.startsWith("openresearch")
  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("openresearch")
        ? {
            ...(openresearchProjectID ? { "x-openresearch-project": openresearchProjectID } : {}),
            "x-openresearch-session": input.sessionID,
            "x-openresearch-request": input.user.id,
            "x-openresearch-client": input.flags.client,
