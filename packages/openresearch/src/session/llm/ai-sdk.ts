import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@openresearch-ai/llm"
...
// Move this extraction into @openresearch-ai/llm when Copilot is handled by the native runtime.
