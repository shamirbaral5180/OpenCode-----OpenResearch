...
import { Usage, type LLMEvent } from "@openresearch-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/SessionProcessor") {}
      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "step-finish": {
            ...
            // prompt. Prefix mismatches mean openresearch changed history behind a signed
