...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "openresearch"
      output.headers["User-Agent"] = `openresearch/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
