import type { Hooks, PluginInput } from "@openresearch-ai/plugin"
import type { Model } from "@openresearch-ai/sdk/v2"
import { InstallationVersion } from "@openresearch-ai/core/installation/version"
import { OauthCallbackPage } from "@openresearch-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. OpenResearch will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
