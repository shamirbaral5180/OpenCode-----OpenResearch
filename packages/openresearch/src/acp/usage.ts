...
import type { AssistantMessage as OpenResearchAssistantMessage, Message } from "@openresearch-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@openresearch-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<OpenResearchAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<OpenResearchAssistantMessage, "role"> &
  Partial<Pick<OpenResearchAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@openresearch/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@openresearch/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@openresearch/ACPUsage") {}
