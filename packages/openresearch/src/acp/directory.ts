...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@openresearch/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@openresearch/ACPDirectory") {}
