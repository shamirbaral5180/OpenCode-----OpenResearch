...
import type * as SDK from "@openresearch-ai/sdk/v2"
...
import { SessionShareTable } from "@openresearch-ai/core/share/sql"
...
const disabled = process.env["OPENRESEARCH_DISABLE_SHARE"] === "true" || process.env["OPENRESEARCH_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/ShareNext") {}
