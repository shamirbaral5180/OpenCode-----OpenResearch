...
import { AccountStateTable, AccountTable } from "@openresearch-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@openresearch/AccountRepo") {}
