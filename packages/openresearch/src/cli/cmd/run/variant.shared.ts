...
//
// The saved variant persists across sessions in ~/.local/state/openresearch/model.json
...
class Service extends Context.Service<Service, VariantService>()("@openresearch/RunVariant") {}
