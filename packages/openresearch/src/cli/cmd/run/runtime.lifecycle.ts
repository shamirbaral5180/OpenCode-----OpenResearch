...
import { openEditor } from "@openresearch-ai/tui/editor"
import { registerOpenResearchKeymap } from "@openresearch-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerOpenResearchKeymap(keymap, renderer, input.tuiConfig)
