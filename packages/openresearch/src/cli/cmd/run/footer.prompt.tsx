...
import { normalizePromptContent } from "@openresearch-ai/tui/editor"
...
import { OPENRESEARCH_BASE_MODE, useBindings } from "@openresearch-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close OpenResearch" } satisfies SlashOption,
    ]
