...
import type { Event, GlobalEvent, OpenResearchClient } from "@openresearch-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@openresearch/RunStreamTransport") {}
