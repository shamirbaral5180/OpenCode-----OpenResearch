// Shared type vocabulary for the direct interactive mode (`openresearch --mini`).
//
...
import type { OpenResearchClient, PermissionRequest, QuestionRequest, ToolPart } from "@openresearch-ai/sdk/v2"
import type { TuiConfig } from "@openresearch-ai/tui/config"
...
type PromptModel = Parameters<OpenResearchClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<OpenResearchClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<OpenResearchClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<OpenResearchClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<OpenResearchClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<OpenResearchClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<OpenResearchClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<OpenResearchClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<OpenResearchClient["question"]["reject"]>[0]
