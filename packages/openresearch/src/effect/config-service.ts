 ...
 *   "@openresearch/ServerAuthConfig",
 *   {
 *     password: Config.string("OPENRESEARCH_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("OPENRESEARCH_SERVER_USERNAME").pipe(Config.withDefault("openresearch")),
 *   },
 * ) {}
 *
