...
const MANAGED_PLIST_DOMAIN = "ai.openresearch.managed"

// Keys injected by macOS/MDM into the managed plist that are not OpenResearch config
...
export function managedConfigDir() {
  return process.env.OPENRESEARCH_TEST_MANAGED_CONFIG_DIR || systemManagedConfigDir()
}
