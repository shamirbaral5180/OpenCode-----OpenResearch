...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openresearch.git")).toEqual({ owner: "sst", repo: "openresearch" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openresearch")).toEqual({ owner: "sst", repo: "openresearch" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openresearch.git")).toEqual({ owner: "sst", repo: "openresearch" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openresearch")).toEqual({ owner: "sst", repo: "openresearch" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openresearch.git")).toEqual({ owner: "sst", repo: "openresearch" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openresearch")).toEqual({ owner: "sst", repo: "openresearch" })
})
