...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENRESEARCH_CALLER", () => {
    process.env["OPENRESEARCH_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENRESEARCH_CALLER", () => {
    process.env["OPENRESEARCH_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENRESEARCH_CALLER", () => {
    process.env["OPENRESEARCH_CALLER"] = "unknown"
