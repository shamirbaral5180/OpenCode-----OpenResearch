...
import { LLMEvent, Usage } from "@openresearch-ai/llm"
...
describe("session.compaction.process", () => {
  ...
  itCompaction.instance(
    "anchors repeated compactions with the previous summary and research evidence",
    () => {
      const stub = llm()
      let captured = ""
      const evidence =
        "S1 https://example.org/study p. 4 (abstract-only); S2 reports/data.md:12; unresolved contradiction S1 vs S2; coverage gap: long-term outcomes"
