...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      OPENRESEARCH_EXPERIMENTAL_WORKSPACES: Flag.OPENRESEARCH_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.OPENRESEARCH_EXPERIMENTAL_WORKSPACES = original.OPENRESEARCH_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
