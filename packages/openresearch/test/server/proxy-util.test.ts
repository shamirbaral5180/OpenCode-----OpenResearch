...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips openresearch-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-openresearch-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-openresearch-directory")).toBeNull()
      expect(result.get("x-openresearch-workspace")).toBeNull()
