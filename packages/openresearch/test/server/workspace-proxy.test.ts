...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips openresearch-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      const request = HttpServerRequest.fromWeb(
        new Request("http://localhost/test", {
          headers: {
            ...
            "x-openresearch-workspace": "ws_123",
            "x-custom": "preserved",
          },
        }),
      )
      ...
      expect(forwarded["x-openresearch-directory"]).toBeUndefined()
      expect(forwarded["x-openresearch-workspace"]).toBeUndefined()
