...
Practical reference for the current tool-migration state in `packages/openresearch`.
...
Tool tests should use the existing Effect helpers in `packages/openresearch/test/lib/effect.ts`:
