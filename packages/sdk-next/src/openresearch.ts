import { OpenResearch } from "@openresearch-ai/client/effect"
...
import { createEmbeddedRoutes } from "@openresearch-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("OpenResearch.create")(function* () {
  ...
  const client = yield* OpenResearch.make({ baseUrl: "http://openresearch.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@openresearch-ai/sdk-next/OpenResearch") {}
