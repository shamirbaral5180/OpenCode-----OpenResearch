...
import { compile, emitEffectImported, emitPromise, write } from "@openresearch-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "OpenResearchEventEncoded",
              import: 'import type { OpenResearchEventEncoded } from "@openresearch-ai/protocol/groups/event"',
            },
          },
        }),
