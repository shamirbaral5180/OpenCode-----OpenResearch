      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://openresearch.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>openresearch.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g openresearch-ai")}>
                <code>
                  npm i -g <strong>openresearch-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g openresearch-ai")}>
                <code>
                  bun add -g <strong>openresearch-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/openresearch")}>
                <code>
                  brew install <strong>anomalyco/tap/openresearch</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S openresearch")}>
                <code>
                  paru -S <strong>openresearch</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask openresearch-desktop")}>
                <code>
                  brew install --cask <strong>openresearch-desktop</strong>
                </code>
                <CopyStatus />
              </button>
