...
import compareVideo from "../../asset/lander/openresearch-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/openresearch-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="openresearch:auth" content={loggedin() ? "true" : "false"} />
