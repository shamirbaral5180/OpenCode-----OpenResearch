...
import { and, Database, eq, isNull } from "@openresearch-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@openresearch-ai/console-core/schema/billing.sql.js"
    ...
    return new Response(
      JSON.stringify({
        ...
        error: {
          ...
          message: "OpenResearch Go subscription required.",
        },
      }),
      {
        status: 403,
