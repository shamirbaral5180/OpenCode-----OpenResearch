...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@openresearch-ai/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@openresearch-ai/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-openresearch-tutorial": "1" },
    query: { debug: "1" },
  },
})
