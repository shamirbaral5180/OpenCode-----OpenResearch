...
> current private `@openresearch-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@openresearch-ai/ai`
...
- Secondary audience: OpenResearch and other durable agent runtimes
...
import { LLM } from "@openresearch-ai/ai"
import { OpenAI } from "@openresearch-ai/ai/providers/openai"
...
```ts
import { Message } from "@openresearch-ai/ai"
...
import { LLM, Tool } from "@openresearch-ai/ai"
...
OpenResearch and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@openresearch-ai/ai/promise"
import { OpenAI } from "@openresearch-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@openresearch-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@openresearch-ai/ai/provider"
...
@openresearch-ai/ai/promise
  Promise/AsyncIterable LLM facade

@openresearch-ai/ai/schema
  serializable domain schemas

@openresearch-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@openresearch-ai/ai/providers/openai
@openresearch-ai/ai/providers/anthropic
@openresearch-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@openresearch-ai/llm`                      | `@openresearch-ai/ai`                                           |
...
OpenResearch should migrate to `generateTurn` / `streamTurn`, preserving its durable
