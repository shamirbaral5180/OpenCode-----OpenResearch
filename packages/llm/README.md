...
Schema-first LLM core for openresearch. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@openresearch-ai/llm"
import { OpenAI } from "@openresearch-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@openresearch-ai/llm/providers"
