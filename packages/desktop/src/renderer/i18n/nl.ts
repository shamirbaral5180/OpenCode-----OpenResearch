export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van OpenResearch",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van OpenResearch is gedownload. Wil je deze installeren en OpenResearch opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'openresearch' te gebruiken.",
