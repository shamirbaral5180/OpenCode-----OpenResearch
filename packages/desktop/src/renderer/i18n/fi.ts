export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo OpenResearchn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenResearchn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää OpenResearchn uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'openresearch'-komentoa.",
