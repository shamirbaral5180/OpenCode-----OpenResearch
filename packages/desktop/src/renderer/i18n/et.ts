export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse OpenResearch uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenResearch'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „openresearch” kasutamiseks taaskäivitage terminal.",
