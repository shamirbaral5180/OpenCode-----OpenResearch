export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon OpenResearch ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenResearchning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'openresearch' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
