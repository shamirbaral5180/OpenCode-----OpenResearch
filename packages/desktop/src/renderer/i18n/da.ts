export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OpenResearch",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OpenResearch er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'openresearch'-kommandoen.",
