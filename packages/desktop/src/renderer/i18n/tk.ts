export const dict = {
  ...
  "desktop.updater.none.message": "OpenResearch-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenResearch-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'openresearch' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
