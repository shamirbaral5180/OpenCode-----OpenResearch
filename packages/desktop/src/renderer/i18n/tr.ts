export const dict = {
  ...
  "desktop.updater.none.message": "OpenResearch'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenResearch'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'openresearch' komutunu kullanmak için terminalinizi yeniden başlatın.",
