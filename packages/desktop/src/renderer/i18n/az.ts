export const dict = {
  ...
  "desktop.updater.none.message": "Artıq OpenResearch-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenResearch-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'openresearch' əmrindən istifadə etmək üçün terminalı yenidən başladın.",
