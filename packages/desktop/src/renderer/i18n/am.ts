export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የOpenResearch ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከOpenResearch ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
  ...
  "desktop.cli.installed.message": "CLI ወደ {{path}} ተጭኗል\n\nየ'openresearch' ትዕዛዝን ለመጠቀም ተርሚናልዎን እንደገና ያስጀምሩት።",
