export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの OpenResearch を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenResearch のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'openresearch' コマンドを使用してください。",
