export const dict = {
  ...
  "desktop.updater.none.message": "თქვენ უკვე იყენებთ OpenResearch-ის უახლეს ვერსიას",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenResearch-ის {{version}} ვერსია ჩამოტვირთულია, გსურთ მისი ინსტალაცია და ხელახლა გაშვება?",
  ...
  "desktop.cli.installed.message":
    "CLI დაინსტალირებულია {{path}}-ზე\n\nგადატვირთეთ ტერმინალი „openresearch“ ბრძანების გამოსაყენებლად.",
