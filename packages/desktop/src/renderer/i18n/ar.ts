export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من OpenResearch",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من OpenResearch. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
