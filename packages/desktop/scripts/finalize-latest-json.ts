...
const releaseId = process.env.OPENRESEARCH_RELEASE
if (!releaseId) throw new Error("OPENRESEARCH_RELEASE is required")

const version = process.env.OPENRESEARCH_VERSION
if (!version) throw new Error("OPENRESEARCH_VERSION is required")
...
const macxTarGz = "openresearch-desktop-mac-x64.app.tar.gz"
const macaTarGz = "openresearch-desktop-mac-arm64.app.tar.gz"
