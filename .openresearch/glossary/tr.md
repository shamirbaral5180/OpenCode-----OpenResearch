...
- PR #15835: https://github.com/anomalyco/openresearch/pull/15835

## Do Not Translate (Locale Additions)

- `OpenResearch` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `openresearch` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `OpenResearch` in prose, `openresearch` only for exact technical identifiers
...
- Avoid changing `openresearch` to `OpenResearch` inside commands, URLs, package names, or code literals
