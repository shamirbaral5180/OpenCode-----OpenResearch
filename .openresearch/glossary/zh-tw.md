...
- PR #13942: https://github.com/anomalyco/openresearch/pull/13942

## Do Not Translate (Locale Additions)

- `OpenResearch` (preserve casing in prose; keep `openresearch` only when it is part of commands, package names, paths, or code)
- `OpenResearch Zen`
- `OpenResearch CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `openresearch` in prose when referring to the product name; use `OpenResearch`
