...
- PR #10809: https://github.com/anomalyco/openresearch/pull/10809
- PR #11496: https://github.com/anomalyco/openresearch/pull/11496

## Do Not Translate (Locale Additions)

- `OpenResearch` (preserve casing in prose; keep `openresearch` only in commands, package names, paths, or code)
- `OpenResearch CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
