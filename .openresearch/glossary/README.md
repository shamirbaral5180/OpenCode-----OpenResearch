...
Use this folder for locale-specific translation guidance that supplements `.openresearch/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/openresearch/pull/12345

## Do Not Translate (Locale Additions)

- `OpenResearch` (preserve casing)
