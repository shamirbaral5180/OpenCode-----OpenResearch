...
mode: primary
hidden: true
model: openresearch/gpt-5.4-mini
color: "#44BA81"
tools:
  "*": false
  "github-triage": true
...
Desktop application and browser-based app issues, including `openresearch web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core openresearch server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

OpenResearch Zen, OpenResearch Go, and billing issues.
